...
if (typeof _tvqsky !== "object") {
    _tvqsky = []
}
if (typeof TV2TrackSky !== "object") {
    TV2TrackSky = (function() {
        var g, a = {},
            p = document,
            c = navigator,
            C = screen,
        ...
        E = new w();
        for (H = 0; H < _tvqsky.length; H++) {
            if (_tvqsky[H][0] === "setTrackerUrl" || _tvqsky[H][0] === "setSiteId") {
                K(_tvqsky[H]);
                delete _tvqsky[H]
            }
        }
