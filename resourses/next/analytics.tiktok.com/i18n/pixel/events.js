...
window[window["TiktokAnalyticsObject"]]._cc = 'UA';
window[window.TiktokAnalyticsObject]._li || (window[window.TiktokAnalyticsObject]._li = {}), window[window.TiktokAnalyticsObject]._li["C0VO58H5A0R73RNS8PEG"] = "42c67044-b870-11ef-a8da-b83fd2cda9be";
window[window["TiktokAnalyticsObject"]]._cde = 390;;
if (!window[window["TiktokAnalyticsObject"]]._server_unique_id) window[window["TiktokAnalyticsObject"]]._server_unique_id = '42c68f5f-b870-11ef-a8da-b83fd2cda9be';
...
! function(i, t, o, n) {
    var e = [{
        ...
        a = {
            "info": {
                "pixelCode": "C0VO58H5A0R73RNS8PEG",
                "name": "Next UK Pixel - New",
                "status": 0,
                "setupMode": 1,
                "partner": "",
                "advertiserID": "6880426421039136770",
                "is_onsite": false,
                ...
                "AutoConfig": {
                    ...
                    "vc_rules": {
                        "amazon.com": [{
                            "version": "stable",
                            "rule_key": "amazon.com",
                            "valueXpath": "//h3[@id='order-summary-checkout-total-price']",
                            "currency": {
                                "val": "$"
                            }
                        }],
                        ...
                        "next.ie": [{
                            "version": "stable",
                            "rule_key": "next.ie",
                            "valueXpath": "//div[@class='col-4 col-md-2']/div[@class='sbm-order-total-price sbm-summary-price-value']",
                            "valueClass": "sbm-order-total-price sbm-summary-price-value",
                            "currency": {
                                "val": "EUR"
                            }
                        }],
                        "nextdirect.com": [{
                            "version": "stable",
                            "rule_key": "nextdirect.com",
                            "valueXpath": "//span[@class='text-body'][contains(text(),'ご注文金額')]/following-sibling::div/span[@class='text-body']",
                            "valueClass": "text-body",
                            "currency": {
                                "val": "￥",
                                "xpath": "//span[contains(@class, 'payment__total--label-and-amount')]/span[contains(@class, 'text-body')]"
                            }
                        }]
                    }
                },
    ...
    var l, p, h = c();
    h || (h = [], window && (window[d()] = h)), Object.assign(a, {
        options: r(i, "_o")
    }), l = a, h._i || (h._i = {}), (p = l.info.pixelCode) && (h._i[p] || (h._i[p] = []), Object.assign(h._i[p], l), h._i[p]._load = +new Date), Object.assign(a.info, {
        loadStart: r(i, "_t"),
        loadEnd: r(i, "_i")._load,
        loadId: h._li && h._li[i] || ""
    }), null != (t = (o = h).instance) && null != (t = t.call(o, i)) && null != (n = t.setPixelInfo) && n.call(t, a.info), l = function(i, t, o) {
    ...
    }(h._plugins, a.plugins, M), p = i, (void 0 !== self.DedicatedWorkerGlobalScope ? self instanceof self.DedicatedWorkerGlobalScope : "DedicatedWorkerGlobalScope" === self.constructor.name) ? self.importScripts && self.importScripts(l) : ((o = document.createElement("script")).type = "text/javascript", o.async = !0, o.src = l, o.setAttribute("data-id", p), (l = document.getElementsByTagName("script")[0]) && l.parentNode && l.parentNode.insertBefore(o, l))
}();