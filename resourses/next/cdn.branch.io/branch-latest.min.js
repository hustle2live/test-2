(function() {
    ...
    */
    ...
    function w(a) {
        try {
            return "object" === typeof JSON && "function" === typeof JSON.stringify ? JSON.stringify(a) : h(a)
        } catch (b) {}
    ...
    function Ba(a, b) {
        ...
        c.href = a;
        a = [t, "https://app.link", "https://bnc.lt"];
        var d = c.origin;
        ...
        if (0 < Object.keys(c).length) {
            if (!b) return !0;
            for (var e in c)
                if (a = new RegExp(c[e]), !b.hasOwnProperty(e) || !a.test(b[e])) return !0
        }
        return !1
    }
            ...
            for (var c = "tags alias channel feature stage campaign type duration sdk source data".split(" "), d = 0; d < c.length; d++) {
                ...
                if (f)
                    if ("tags" === e && Array.isArray(f))
                        for (var m = 0; m < f.length; m++) a = ("?" === a[a.length - 1] ? a + e : a + "&" + e) + "=" + encodeURIComponent(f[m]);
                    else if ("string" === typeof f && 0 < f.length || "number" === typeof f) "data" === e && "string" === typeof f && (f = Da(f)), a = ("?" === a[a.length - 1] ? a + e : a + "&" + e) + "=" + encodeURIComponent(f)
            }
            return a
        }
    }
    ...
    function Ja(a) {
        ...
        "string" ===
        typeof b.$desktop_url && (b.$desktop_url = b.$desktop_url.replace(/#r:[a-z0-9-_]+$/i, "").replace(/([\?&]_branch_match_id=\d+)/, ""));
        try {
            v(b)
        } catch (d) {
            b = h(b)
    ...
    function F() {
        ...
        return a.match(/android/i) ? "android" : a.match(/ipad/i) || a && Na(a) && a && -1 < a.indexOf("Macintosh") && Oa(a, 13) && screen.height > screen.width ? "ipad" : a.match(/i(os|p(hone|od))/i) ? "ios" : a.match(/\(BB[1-9][0-9]*;/i) ? "blackberry" : a.match(/Windows Phone/i) ? "windows_phone" : a.match(/Kindle/i) || a.match(/Silk/i) || a.match(/KFTT/i) || a.match(/KFOT/i) || a.match(/KFJWA/i) || a.match(/KFJWI/i) || a.match(/KFSOWI/i) || a.match(/KFTHWA/i) || a.match(/KFTHWI/i) || a.match(/KFAPWA/i) || a.match(/KFAPWI/i) ?
            "kindle" : a.match(/(Windows|Macintosh|Linux)/i) ? "desktop" : "other"
    }
    ...
    function Da(a) {
        ...
        for (a = e; d < a.length;) {
            ...
            b = b + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f) +
                "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(g)
        }
        return b
    }
    ...
    function Ya(a) {
        if (!a) return null; - 1 < a.indexOf("://") ? a = a.split("://")[1] : "/" === a.charAt(0) && (a = a.slice(1));
        return a
    }
    ...
    function Za() {
        ...
        for (var c = {
            ...
            if ((a[d].getAttribute("name") || a[d].getAttribute("property")) && a[d].getAttribute("content")) {
                ...
                e = e || f;
                f = e.split(":");
                3 === f.length && "branch" === f[0] && "deeplink" === f[1] && ("$ios_deeplink_path" === f[2] ? c.hostedIOS =
                    Ya(a[d].getAttribute("content")) : "$android_deeplink_path" === f[2] ? c.hostedAndroid = Ya(a[d].getAttribute("content")) : b[f[2]] = a[d].getAttribute("content"));
    ...
    function db(a) {
        ...
        if (a.hasOwnProperty("products")) {
            ...
            a.products.forEach(function(f) {
                "object" !== typeof f && (e = cb.invalidProductType);
    ...
    function eb(a, b) {
        return a && "string" === typeof a && -1 !== bb.indexOf(a.toLowerCase()) ? b && "object" === typeof b && 0 !== Object.keys(b || {}).length ? (a = db(b)) ? a : null : cb.missingCommerceData : cb.missingPurchaseEvent
    }
    ...
    function G(a, b, c) {
        if (null !== c && void 0 !== c) {
            if ("object" === typeof c && 0 === Object.keys(c || {}).length) return a;
            a[b] = c
        }
        return a
    }
    ...
    function qb() {
        navigator.userAgentData ? navigator.userAgentData.getHighEntropyValues(["model", "platformVersion"]).then(function(a) {
            ...
            if (a = a.platformVersion) {
                var c = /^([1-9]\d*)\.(0\d*)(\.[0]\d*){1,}$/; - 1 !== a.indexOf(".") && (a = a.replace(c, a.substring(0, a.indexOf("."))))
            }
            y = {
                model: b,
                platformVersion: a
    ...
    function rb(a, b = {}, c) {
        ...
        if (["/v1/open", "/v1/pageview"].includes(c)) Object.assign(a, e);
        else if (d.includes(c)) try {
            let f;
    ...
    function K(a, b) {
        return function(c, d, e) {
            ...
            if ("number" === typeof e || e)
                if (0 === b) {
                    if ("object" !== typeof e) return A("API request $1, parameter $2 is not $3", [c, d, "an object"])
                } else if (3 === b) {
    ...
    function Jb(a) {
        ...
        return {
            ...
            get: function(c, d) {
                return "browser_fingerprint_id" === c || "alternative_browser_fingerprint_id" === c ? d && localStorage ? Ta(localStorage.getItem(L(c))) : Ta(b.getItem(L(c))) : Gb(d && localStorage ?
                    localStorage.getItem(L(c)) : b.getItem(L(c)))
            },
            set: function(c, d, e) {
    ...
    function Mb(a, b, c) {
        ...
        for (var e in b) b.hasOwnProperty(e) && (b[e] instanceof Array || "object" === typeof b[e] ? d.push(Mb(a, b[e], c ? c + "." + e : e)) : d.push(encodeURIComponent(c ? c + "." + e : e) + "=" + encodeURIComponent(b[e])));
        return d.join("&")
    }

    function Nb(a, b, c) {
        var d, e = b.destination + b.endpoint,
            f = /^[0-9]{15,20}$/,
        ...
        var k = {};
        if ("undefined" !== typeof b.h && "/v1/pageview" !== b.endpoint && "/v1/dismiss" !== b.endpoint)
            for (g in b.h) {
                ...
                b.endpoint || "/v1/dismiss" === b.endpoint) D(k, c), k.branch_requestMetadata && delete k.branch_requestMetadata;
        ...
        if ("POST" === b.method) try {
            ...
            if (c.branch_key && m.test(c.branch_key)) g.branch_key = c.branch_key;
            else if (c.app_id &&
                f.test(c.app_id)) g.app_id = c.app_id;
            else if (c.instrumentation) g.instrumentation = c.instrumentation;
            else throw Error(A("API request $1 missing parameter $2", [b.endpoint, "branch_key or app_id"]));
        } catch (u) {
            return {
                error: u.message
            }
    ...
    function Ob(a, b, c, d, e) {
        ...
        a.createScript(b + (0 > b.indexOf("?") ? "?" : "") + (c ? g + c : "") + (0 <= b.indexOf("/c/") ? "&click=1" : "") + "&callback=" + k, function() {
            e(Error("Request blocked by client, probably adblock"),
                null)
        }, function() {
            G(x, m, wa(f));
            try {
    ...
    function Pb(a, b, c, d, e, f, m, k) {
        ...
        l.onerror = function(p) {
            var q = "Error in API: URL - " + (l.responseURL || "Unknown") + ", Status - " + (l.status || "No status available") + ", Response - " + (l.responseText || "No response text available");
            console.log(q);
            f(Error(p.error || q), null, l.status)
        };
        l.onreadystatechange = function() {
            if (4 ===
                l.readyState)
                if (G(x, u, wa(g)), 200 === l.status) {
                    if ("arraybuffer" === l.responseType) var p = l.response;
                    else if (m) p = l.responseText;
                    else try {
                        p = v(l.responseText)
                    } catch (q) {
                        p = {}
                    ...
                    f(null, p, l.status)
                } else if ("4" === l.status.toString().substring(0, 1) || "5" === l.status.toString().substring(0, 1)) l.responseURL && l.responseURL.includes("v2/event") ? f(l.responseText, null, l.status) : (p = "Error in API: URL - " + (l.responseURL || "Unknown") + ", Status - " + (l.status || "No status available") + ", Response - " + (l.responseText || "No response text available"),
                console.log(p), f(Error(p), null, l.status))
        };
        try {
    ...
    function Qb(a, b, c, d, e) {
        ...
        function m(r, H, E) {
            "function" === typeof a.ga && a.ga(l, b.method, p, r, E, H);
            r && 0 < q && "5" === (E || "").toString().substring(0, 1) ? (q--, window.setTimeout(function() {
                f()
            }, pa)) : e(r, H)
        }
        ...
        if (z)
            for (var k = ["browser_fingerprint_id",
                    "alternative_browser_fingerprint_id", "identity_id", "session_id", "identity"
                ], g = 0; g < k.length; g++) c.hasOwnProperty(k[g]) && delete c[k[g]];
        k = Nb(a, b, c);
        ...
        var u = "";
        if ("GET" === b.method) var l = k.url + "?" + k.data;
        else l = k.url, u = k.data;
        var p;
    ...
    function bc(a, b, c) {
        ...
        if (a.I || a.T) {
            if (a.I) {
                var e = "";
                for (var f = 0; 5 > f; f++) e += '<span class="star"><svg class="star" fill="#555555" height="12" viewBox="3 2 20 19" width="12"><path d="M22 9.24l-7.19-.62L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21 12 17.27 18.18 21l-1.63-7.03L22 9.24zM12 15.4l-3.76 2.27 1-4.28-3.32-2.88 4.38-.38L12 6.1l1.71 4.04 4.38.38-3.32 2.88 1 4.28L12 15.4z"/><path d="M0 0h24v24H0z" fill="none"/><foreignObject display="none"><span class="star">\u2606</span></foreignObject></svg>',
    ...
    function dc(a, b, c, d) {
        ...
        O(a, "willShowBanner");
        var f, m = document.body.style.marginTop,
        ...
        cc(b, d, function(g) {
            ...
            if (l = g.getElementById("branch-banner-close")) l.onclick = function(q) {
                q.preventDefault();
                O(a, "willCloseBanner");
                e({}, function() {
                    O(a, "didCloseBanner")
            ...
            if (g = g.getElementById("branch-banner-modal-background")) g.onclick = function(q) {
                q.preventDefault();
                O(a, "willCloseBanner");
                e({}, function() {
                    O(a, "didCloseBanner")
    ...
    function Mc(a) {
        nc = [];
        if (a && a.injectorSelector && (a = document.querySelectorAll(a.injectorSelector)))
            for (var b = 0; b < a.length; b++) nc.push(a[b].parentElement)
    }
    ...
    function Rc(a) {
        ...
        0 < nc.length && nc.forEach(function(f) {
            var m, k = window.getComputedStyle(f);
            k && (m = gc && "fixed" === k.getPropertyValue("position"));
            m || (f.style.marginTop = R)
        });
        "top" === Gc &&
            Gc !== P && Fc && Hc && 0 < Hc.length && Hc.forEach(function(f) {
                f.style.marginTop = 0
            });
        Fc = !1;
        Gc = "";
    ...
    function Sc() {
        ...
        if (ic) {
            ...
            a = a + ("#branch-banner-iframe-embed { z-index: 99999!important; height: " +
    ...
    function Tc(a, b) {
        ...
        setTimeout(function() {
            b ? (a.style.top = null, a.style.bottom = null) : "top" === P ? a.style.top = "0" : "bottom" === P && (U && U.journey_link_data && !U.journey_link_data.safeAreaRequired ? a.style.bottom = "0" : (oc = !0, document.getElementById("branch-banner-iframe").style.transition =
                "all 0s", Uc(!1, !0), window.addEventListener("resize", Vc), window.addEventListener("scroll", Wc)));
    ...
    function Yc(a, b, c, d, e, f, m) {
        ...
        }), $c(".branch-banner-continue", "didClickJourneyContinue", c, e, a, b, f, m, k, "click"), $c(".branch-banner-close", "didClickJourneyClose", c, e, a, b, f, m, k, "click"), $c(".branch-banner-dismiss-background", "didClickJourneyBackgroundDismiss", c, e, a, b, f, m, k, "click"), $c(".branch-banner-dismiss-background",
            "didScrollJourneyBackgroundDismiss", c, e, a, b, f, m, k, "touchmove"))
    }
    ...
    function cd(a) {
        return void 0 === a || null === a ? null : a.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;/g, "&").replace(/&quot;/g, '"').replace(/&apos;/g, "'").replace(/&brvbar;/g, "\u00a6").replace(/&laquo;/g, "\u00ab").replace(/&acute;/g, "\u00b4").replace(/&middot;/g, "\u00b7").replace(/&raquo;/g, "\u00bb").replace(/&amp;/g, "&").replace(/&iquest;/g, "\u00bf").replace(/&times;/g, "\u00d7").replace(/&divide;/g, "\u00f7").replace(/&Agrave;/g, "\u00c0").replace(/&Aacute;/g, "\u00c1").replace(/&Acirc;/g, "\u00c2").replace(/&Atilde;/g,
    ...
    function ad(a, b, c, d, e, f, m, k) {
        ...
        if (!m) {
            ...
            var u = function() {
                T.removeListener(u);
                var l = dd(k, xa[a]);
                T.j(Cb, l, function(p, q) {
                    !p && f && f.dismissRedirect ? window.location = f.dismissRedirect : !p && "object" === typeof q && q.template && k.U(q, null, !1) && k.P(q.template, l, l.branch_view_id || q.event_data.branch_view_data.id, q.event_data.branch_view_data, !1, q.journey_link_data)
                })
            };
    ...
    function Zc(a, b) {
        ...
        setTimeout(function() {
            ...
            oc && (oc = !1, window.removeEventListener("resize",
                Vc), window.removeEventListener("scroll", Wc));
    ...
    function fd(a) {
        ...
        if (a && "object" === typeof a && 0 < Object.keys(a || {}).length) {
            var c = ["browser_fingerprint_id", "app_id", "source", "open_app", "link_click_id"];
            if (a && "object" === typeof a && !Array.isArray(a) && 0 < Object.keys(a).length && c && Array.isArray(c) && 0 < c.length)
                for (var d in a) a.hasOwnProperty(d) && -1 < c.indexOf(d) && delete a[d];
            b.journey_link_data = {};
    ...
    function jd(a, b, c) {
        ...
        k.onload = function() {
            ...
            (g = l.querySelector('meta[name="accessibility"]')) && "wcag" ===
            ...
            try {
                ...
                var q = window.getComputedStyle(p).getPropertyValue("background-color").split(", ");
                q[3] && 0 === parseFloat(q[3]) && (k.style.boxShadow = "none")
            } catch (Y) {}
            p = d;
            (q = k.contentWindow.document) && q.getElementById("branch-mobile-action") && (q = q.getElementById("branch-mobile-action"), q.innerHTML = p, q.setAttribute("aria-label", p));
            p = Object.assign({}, U);
            p.bannerHeight = R;
        ...
        ic ? (b.appendChild(k), document.body.appendChild(b)) : document.body.prepend(k)
    }
    V.U = function(a, b, c) {
        ...
        if (!tc) {
            ...
            if (a) {
                ...
                window[u] = function(n) {
                    ...
                    g || (l = n, Yc(c, m, p, l, null, q, e))
                };
                jd(a, b.has_app_websdk,
                    function(n) {
                        Ac = n;
                        null === n ? g = !0 : (Yc(c, m, p, l, n, q, e), ta && (x["journey-load-time"] = (Date.now() - window.performance.timing.navigationStart).toString()), document.body.removeChild(k), z || e || V.ea(d))
                    })
    ...
    V.O = function(a, b, c, d) {
        ...
        var q = f.hasOwnProperty("session_link_click_id") ? f.session_link_click_id : null;
        ...
        return function() {
            ...
            d.ia(function(k) {
                ...
                if (!c) {
                    ...
                    if (2 === d.A) return g(Error(A("Branch SDK initialization failed, so further methods cannot be called", d.B,
                        d.D)), null);
    ...
    Z.prototype.j = function(a, b, c) {
        ...
        (a.h && a.h.link_click_id || a.i && a.i.link_click_id) && this.fa && (b.link_click_id =
            this.fa);
        ...
        if (this.l)
            for (var d in this.l) this.l.hasOwnProperty(d) && (b.branch_requestMetadata || (b.branch_requestMetadata = {}), b.branch_requestMetadata[d] = this.l[d]);
        va.hasOwnProperty(a.endpoint) && (d = this.g.get("branch_dma_data", !0), b.branch_dma_data = d ? v(d) : null);
        "/_r" !== a.endpoint && (a.destination = t);
        return Qb(this.$,
            a, b, this.g,
            function(e, f) {
                c(e, f)
    ...
    function W(a, b) {
        ...
        if (ya && b && (b = (c = N(a.g, !0)) && c.referring_link, c = c && c.referringLinkExpiry, b && c))
            if ((new Date).getTime() > c) Zb(a.g, {
    ...
    Z.prototype.init = X(2, function(a, b, c) {
        function d() {
            if ("undefined" !== typeof document.hidden) {
                var n = "hidden";
                var r = "visibilitychange"
            } else "undefined" !== typeof document.mozHidden ? (n = "mozHidden", r = "mozvisibilitychange") : "undefined" !== typeof document.msHidden ? (n = "msHidden", r = "msvisibilitychange") : "undefined" !== typeof document.webkitHidden && (n = "webkitHidden", r = "webkitvisibilitychange");
            r && !g.la && (g.la = !0, document.addEventListener(r, function() {
        ...
        function e(n,
            r) {
            r && (r = k(r), z || (r = f(r), Fa(g.g, r, p)), g.A = 3, r.data_parsed = r.data && 0 !== r.data.length ? v(r.data) : {});
            if (n) return g.A = 2, g.B || (g.B = 1, g.D = n.message), a(n, r && Ga(r));
            try {
                a(n, r && Ga(r))
            } catch (E) {} finally {
                g.renderFinalize()
            ...
            n = gb();
            (r = I(c.metadata, "object") ? c.metadata : null) && (r = ob(n.hosted_deeplink_data, r)) && 0 < Object.keys(r).length && (n.hosted_deeplink_data = r);
            var H = V.O(ed(c, n), c, g, !1);
            g.renderQueue(function() {
                g.j(Bb, H, function(E, S) {
                    E || "object" !== typeof S || (E = H.branch_view_id ? !0 : !1, V.U(S, c, E) ? V.P(S.template, H,
        ...
        function m(n) {
            var r = {
                ...
                H = N(g.g) || {},
                E = N(g.g, !0) || {};
            E.browser_fingerprint_id && (r._t = E.browser_fingerprint_id);
            Pa() || Qa() || g.j(vb, r, function(S, ac) {
                S && (g.B = 3, g.D =
                    S.message);
        ...
        function k(n) {
            ...
            n.link && (g.ha = n.link);
            if (n.referring_link) {
                var r = n.referring_link;
                n.referring_link = r ? "http" !== r.substring(0, 4) ? "https://bnc.lt" + r : r : null
            }!n.click_id && n.referring_link && (n.click_id =
                Ka(n.referring_link));
        ...
        var g = this;
        g.A = 1; - 1 < b.indexOf("key_") ? g.o = b : g.aa = b;
        c = c && I(c, "object") ? c : {};
        ...
        z = c && c.tracking_disabled &&
            !0 === c.tracking_disabled ? !0 : !1;
        ...
        if (b && b.session_id && !l && !Ra("branchify_url")) Yb(g.g, {
            ...
            var q = N(g.g, !0) || {};
            q.browser_fingerprint_id && (b._t = q.browser_fingerprint_id);
            q.identity && (g.m = q.identity);
            var Y = parseInt(Ra("[?&]_open_delay_ms"), 10);
            Pa() || Qa() ? pb(function() {
                g.j(ub, {
                    link_identifier: l,
                    browser_fingerprint_id: l || q.browser_fingerprint_id,
                    identity: q.identity ? q.identity : null,
                    alternative_browser_fingerprint_id: q.browser_fingerprint_id,
                    options: c,
                    ...
                    n || "object" !== typeof r || (r.branch_view_enabled && (g.K = !!r.branch_view_enabled, g.g.set("branch_view_enabled", g.K)), l && (r.click_id = l));
                    d();
                    e(n, r)
                })
            }, Y) : g.j(vb, b, function(n, r) {
                if (n) return g.B = 3, g.D = n.message, e(n, null);
                pb(function() {
                    g.j(ub, {
                        link_identifier: l,
                        browser_fingerprint_id: l || r,
                        identity: q.identity ? q.identity : null,
                        alternative_browser_fingerprint_id: q.browser_fingerprint_id,
                        options: c,
                        initial_referrer: nb(W(g)),
                        ...
                        H || "object" !== typeof E || (E.branch_view_enabled && (g.K = !!E.branch_view_enabled, g.g.set("branch_view_enabled", g.K)), l && (E.click_id = l));
                        d();
                        e(H, E)
                    })
                }, Y)
    ...
    Z.prototype.qrCode = X(2, function(a, b, c) {
        ...
        this.j(xb, Ja(b), function(d, e) {
            ...
            d || (f.rawBuffer = e, f.base64 = function() {
                if (this.rawBuffer) {
                    const m = Array.from(new Uint8Array(e)).map(k => String.fromCharCode(k)).join("");
                    return btoa(m)
                }
    ...
    Z.prototype.closeJourney = X(1, function(a) {
        ...
        b.renderQueue(function() {
            if (Ac && Bc) O(b, "didCallJourneyClose", U), Zc(Ac, !0);
            else return a("Journey already dismissed.")
        });
        a()
    });
    Z.prototype.banner = X(1, function(a, b, c) {
        ...
        if (["other", "desktop"].includes(F())) console.info("banner functionality is not supported on this platform");
        else {
            c = c || {};
            ld.call(null, this, function() {}, c);
            "undefined" === typeof b.showAgain && "undefined" !== typeof b.forgetHide && (b.showAgain =
                b.forgetHide);
            var d = {
                icon: fb(b.icon) || "",
                title: fb(b.title) || "",
                ...
                V: "undefined" ===
                    typeof b.showAndroid ? !0 : b.showAndroid,
    ...
    Z.prototype.disableTracking = X(1, function(a, b) {
        if (!1 === b || "false" === b) Aa = z = !1, this.o && this.N && (!0 === this.N.tracking_disabled && delete this.N.tracking_disabled, this.init(this.o, this.N));
        else if (void 0 === b || !0 === b || "true" === b) Ea(this), Aa = z = !0, this.closeBanner(), this.closeJourney();
        a()
    }, !0);
    ...
    Z.prototype.setDMAParamsForEEA = X(1, function(a, b, c, d) {
        try {
            var e = (f, m) => !0 !== f && !1 !== f ? (console.warn(`setDMAParamsForEEA: ${m} must be boolean, but got ${f}`), !1) : !0;
    ...
    Z.prototype.setAPIUrl = function(a) {
        a && "" !== a.trim() && RegExp("^(https?)://((([a-z\\d]([a-z\\d-]*[a-z\\d])*)\\.)+[a-z]{2,}|((\\d{1,3}\\.){3}\\d{1,3}))(\\:\\d+)?(\\/[-a-z\\d%_.~+]*)*(\\?[;&a-z\\d%_.~+=-]*)?(\\#[-a-z\\d_]*)?$", "i").test(a) ? t = a : console.error("setAPIUrl: Invalid URL format. Default URL will be set.")
    };
    ...
    if (window.branch && window.branch._q)
        for (var nd = window.branch._q, od = 0; od < nd.length; od++) {
            var pd = nd[od];
            md[pd[0]].apply(md, pd[1])
        }
    "function" === typeof define && define.amd ? define("branch", function() {
        return md
    }) : "object" === typeof exports && (module.exports = md);
