var OneTrustStub = (t => {
    var a, o, r, e, l = new function() {
        ...
        s = ((g = y = y || {})[g.Days = 1] = "Days", g[g.Weeks = 7] = "Weeks", g[g.Months = 30] = "Months", g[g.Years = 365] = "Years", (g = e = e || {}).Name = "OTGPPConsent", g[g.ChunkSize = 4e3] = "ChunkSize", g.ChunkCountParam = "GPPCookiesCount", (g = a = a || {}).CPRA = "usca", g.CCPA = "usca", g.CDPA = "usva", g.USNATIONAL = "usnat", g.COLORADO = "usco", g.CTDPA = "usct", g.UCPA = "usut", g.IAB2V2 = "tcfeuv2", (g = o = o || {})[g.CPRA = 8] = "CPRA", g[g.CCPA = 8] = "CCPA", g[g.CDPA = 9] = "CDPA", g[g.USNATIONAL = 7] = "USNATIONAL", g[g.COLORADO = 10] = "COLORADO", g[g.UCPA = 11] = "UCPA", g[g.CTDPA = 12] = "CTDPA", g[g.IAB2V2 = 2] = "IAB2V2", "geo"),
        u = "otpreview",
        p = (e.Name, "PRODUCTION"),
        n = ((g = {})[y.Days] = "PCenterVendorListLifespanDay", g[y.Weeks] = "LfSpnWk", g[y.Months] = "PCenterVendorListLifespanMonth", g[y.Years] = "LfSpnYr", i.prototype.camelize = function(t) {
    ...
    var d = new function() {
        ...
        m = (h.initCSPTrustedType = function(t) {
            var n = new URL(t);
        ...
        }, h.createScriptURL = function(t) {
            return h.isCspTrustedType() ? window.OtTrustedType.TrustedTypePolicy.createScriptURL(t) : t
        }, h.checkAndAssignCspTrustedTypeEnabled = function(t) {
    ...
    f.prototype.initConsentSDK = function() {
        ...
        this.setDomainDataFileURL(), this.crossOrigin = l.stubScriptElement.getAttribute("crossorigin") || null, this.previewMode = "true" === l.stubScriptElement.getAttribute("data-preview-mode"), this.otFetch(l.bannerDataParentURL, this.getLocation.bind(this))
        ...
        return new RegExp("^file://", "i").test(e) && t.MobileSDK ? (e = "/" + t.GeolocationUrl.replace(/^(http|https):\/\//, "").split("/").slice(1).join("/") + ".js", l.storageBaseURL + e) : t.GeolocationUrl
        ...
        var i = document.createElement("script"),
            n = m.createScriptURL(t);
        i.setAttribute("src", n), this.nonce && i.setAttribute("nonce", this.nonce), i.async = !0, i.type = "text/javascript", this.crossOrigin && i.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(i), new RegExp("^file://", "i").test(t) || l.mobileOnlineURL.push(t), e && (i.onload = i.onerror = function() {
            e()
        })
    }, f.prototype.getRegionSet = function(t) {
        var e, i, n, a = l.userLocation,
        ...
        for (var t = [], e = l.optanonHtmlGroupData.length, i = 0; i < e; i++) this.endsWith(l.optanonHtmlGroupData[i], ":1") && t.push(l.optanonHtmlGroupData[i].replace(":1", ""));
        for (e = l.optanonHostData.length, i = 0; i < e; i++) this.endsWith(l.optanonHostData[i], ":1") && t.push(l.optanonHostData[i].replace(":1", ""));
        for (e = l.genVendorsData.length, i = 0; i < e; i++) this.endsWith(l.genVendorsData[i], ":1") && t.push(l.genVendorsData[i].replace(":1", ""));
        for (e = l.vendorsServiceData.length, i = 0; i < e; i++) this.endsWith(l.vendorsServiceData[i], ":1") && t.push(l.vendorsServiceData[i].replace(":1", ""));
        ...
        t && (l.isMigratedURL ? l.storageBaseURL = t.split("/consent/" + l.migratedCCTID)[0] : l.storageBaseURL = (e ? t.split("/consent") : t.split("/scripttemplates/" + l.stubFileName))[0]), this.storageBaseURL = l.storageBaseURL, this.isPreview && -1 === this.domainId.indexOf("test") ? this.domainId = this.domainId + "-test" : this.isPreview = !1, l.bannerBaseDataURL = l.storageBaseURL && l.storageBaseURL + "/consent/" + this.domainId, l.bannerDataParentURL = l.bannerBaseDataURL + "/" + this.domainId + ".json"
        ...
        var t = "true" === this.urlParams.get("otreset"),
            ...
            i = (this.geoFromUrl = (this.urlParams.get("otgeo") || "").toLowerCase(), this.readCookieParam(u, "expiry")),
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202411.2.0")
    };
    var g = f;
    ...
    function f() {
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.buildType = "undefined", this.addBannerSDKScript = function(t) {
            var e = s.getRegionSet(t),
                i = (e.GCEnable || (s.updateGtmMacros(), s.gtmUpdated = !0), s.iabTypeAdded && ("IAB2" !== e.Type && "IAB2V2" !== e.Type || (s.iabType = e.Type, s.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && s.removeTcf(), e.IsGPPEnabled ? d.init() : d.removeGppApi(), l.stubScriptElement.cloneNode(!0)),
                n = "",
                n = t.UseSDKRefactor ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version + "/" + l.bannerScriptName) : "5.11.0" === t.Version ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/old/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + l.bannerScriptName) : (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/" + t.Version + "/" + l.bannerScriptName);
            ...
            }), s.charset = l.stubScriptElement.getAttribute("charset"), s.isAmp = !!l.stubScriptElement.getAttribute("amp"), window.otStubData = {
            ...
            c(n, "display: none;", !0), n.name = t, n.setAttribute("title", e + " Locator"), i.document.body.appendChild(n)
    ...
    var y = new g;
    return t.OtSDKStub = g, t.otSdkStub = y, t
})({});