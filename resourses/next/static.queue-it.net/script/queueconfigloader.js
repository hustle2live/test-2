        ...
        (function(KnownUser) {
            var AjaxInterceptor = /** @class */ (function() {
                ...
                AjaxInterceptor.interceptOpen = function(domainToIntercept, en, getCurrentUrl, redirector, location) {
                    if (getCurrentUrl === void 0) {
                        getCurrentUrl = null;
                    }
                    if (redirector === void 0) {
                        redirector = null;
                    }
                    if (location === void 0) {
                        location = null;
                    ...
                    getCurrentUrl = getCurrentUrl || (function() {
                    ...
                    return function(method, url, async, user, password) {
                        ...
                        try {
                            ...
                            if (xhr.shouldBeIntercepted) {
                                var _a = KnownUser.RequestInterceptHelper.getAjaxHeader(context.GetCurrentUrl()),
                                    headerName = _a[0],
                                    headerValue = _a[1];
        ...
        (function(KnownUser) {
            var FetchInterceptor = /** @class */ (function() {
                ...
                FetchInterceptor.addQueueItHeadersToFetchRequest = function(input, init, currentUrl) {
                    var _a = KnownUser.RequestInterceptHelper.getAjaxHeader(currentUrl),
                        ajaxHeaderName = _a[0],
                        value = _a[1];
                    if (input instanceof Request) {
                ...
                FetchInterceptor.interceptFetch = function(domainToIntercept, env, getCurrentUrl, redirector, location) {
                    ...
                    scope.fetch = function(input, init) {
                        ...
                        var _a = FetchInterceptor.addQueueItHeadersToFetchRequest(input, init, getCurrentUrl()),
                            request = _a[0],
                            options = _a[1];
        ...
        (function(IntegrationConfig) {
            ...
            var IntegrationPointBase = /** @class */ (function() {
                ...
                IntegrationPointBase.CreateIntegrationPoint = function(model, triggerFactory) {
                    if (triggerFactory === void 0) {
                        triggerFactory = Trigger.CreateTrigger;
                    }
            ...
            var Trigger = /** @class */ (function() {
                ...
                Trigger.CreateTrigger = function(model, triggerPartFactory) {
                    if (triggerPartFactory === void 0) {
                        triggerPartFactory = ValidatorBase.CreateValidator;
                    }
            ...
            function applyIntegrationConfig(config, integrationPointFactory, getCurrentProtocol) {
                if (integrationPointFactory === void 0) {
                    integrationPointFactory = IntegrationPointBase.CreateIntegrationPoint;
                }
                if (getCurrentProtocol === void 0) {
            ...
            QueueIt.Javascript.PageEventIntegration = {
                initQueueClient: applyIntegrationConfig
            };
