function UET(o) {
        ...
        if (t) {
            ...
            try {
                if (this.uetConfig.tcf.gdprApplies = n.gdprApplies, n.gdprApplies === !0) {
                    ...
                    (n.vendor.consents[this.uetConfig.tcf.vendorId] === !0 || n.vendor.legitimateInterests[this.uetConfig.tcf.vendorId] === !0) && (this.uetConfig.tcf.adStorageAllowed = i(1), this.uetConfig.tcf.measurementAllowed = i(7) && i(9) && i(10), this.uetConfig.tcf.personalizationAllowed = i(3) && i(4));
                    this.uetConfig.tcf.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.vids, delete this.beaconParams.msclkid)
                }
            } catch (r) {}
            this.uetConfig.tcf.hasLoaded || (this.uetConfig.tcf.hasLoaded = !0, clearTimeout(this.uetConfig.tcf.timeoutId), this.uetConfig.tcf.timeoutId = null, this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.consent.enforced = !1));
            this.fireConsentPing("tcf");
            this.uetLoaded !== !0 && this.checkuetHostdocumentload()
        }
    };
    this.getClUrl = function(n) {
        return this.uetConfig.consent.enabled === !0 && this.uetConfig.consent.adStorageAllowed === !1 || this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 && this.uetConfig.tcf.gdprApplies === !0 && this.uetConfig.tcf.adStorageAllowed !== !0 ? n.replace(this.domain, this.domainCl) : n
    };
    this.isAdStorageAllowed = function() {
        return !(this.beaconParams.Ver < 2 || this.uetConfig.cookieAllowed === !1 || this.uetConfig.consent.enabled === !0 && this.uetConfig.consent.adStorageAllowed === !1 || this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 && this.uetConfig.tcf.gdprApplies === !0 && this.uetConfig.tcf.adStorageAllowed !== !0)
    };
    ...
    this._push = function(n) {
        ...
        if (n[1] instanceof Array)
            ...
            if (t.hasOwnProperty("source") && this.stringExists(t.source) && t.source.indexOf("gtm_") === 0 && (o = !0, t.source === "gtm_update" && t.hasOwnProperty("ad_storage") && (this.fireSendBeacon("gtmConsent", {
                    gasc: t.ad_storage !== "denied" ? "G" : "D"
                }), this.uetConfig.cusig.blob.ec === !0 && (o = !1)), o)) return;
            this.uetConfig.consent.enabled = !0;
            f === "default" ? (t.hasOwnProperty("ad_storage") && this.uetConfig.consent.adStorageUpdated === !1 && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.enforced = !1), this.fireConsentPing("default"), t.hasOwnProperty("wait_for_update") && (r = parseInt(t.wait_for_update, 10), !isNaN(r) && r > 0 && (r = Math.min(r, 1e4), this.uetConfig.consent.waitForUpdate = r))) : f === "update" && t.hasOwnProperty("ad_storage") && (this.uetConfig.consent.adStorageAllowed = t.ad_storage !== "denied", this.uetConfig.consent.adStorageUpdated = !0, this.uetConfig.consent.enforced = !1, this.uetConfig.consent.adStorageAllowed ? this.pageLoadDispatch && this.addMsClkId(this.beaconParams) : (delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.vids, delete this.beaconParams.msclkid), this.fireConsentPing("update"))
        } else if (n[0] === "config") {
            if (t = n[1][1], f = n[1][0], t === null || typeof t != "object") return;
            f === "tcf" && t.hasOwnProperty("enabled") && t.enabled === !0 && typeof __tcfapi == "function" && (this.uetConfig.tcf.enabled = !0, window.__tcfapi("addEventListener", 2, this.tcfCallback.bind(this)))
        }
    };
    ...
    this.addUrlData = function(n, t) {
        ...
        return f || (u = window.document.referrer, i = window.location.href, (this.uetConfig.removeQueryFromUrls === !0 || t) && (i = i.split("?")[0], u = u.split("?")[0]), o = window.location.hash, s = i.indexOf(o) >= 0 ? i : i + o, n.p = encodeURIComponent(s), n.r = encodeURIComponent(u)), t && delete n.r, n
    };
    ...
    this.evt = function(n, t, i, r) {
        ...
        if (r = r !== !1, i = i || {}, this.uetConfig.disableAutoPageView === !0 && this.evqDispatch === !1 && this.dispatchq(!1), typeof i == "object") {
            if (this.uetConfig.allRep === !0 ? i.rep = "1" : i.hasOwnProperty("rep") && (i.rep === 1 || i.rep === "1" || i.rep === !0 ? i.rep = "1" : delete i.rep), this.enforceConsent(), n === this.pageLoadEvt && (this.uetConfig.gtagPid === !0 && "enhanced_conversion_data" in window && typeof enhanced_conversion_data == "object" && (this.pageLevelParams.pid = {
                ...
                }), r && this.pageLevelParams.hasOwnProperty("pid") && !i.hasOwnProperty("pid") && (i.pid = this.pageLevelParams.pid)), this.pageLevelParams.hasOwnProperty("pid") && (this.knownEvents[t] = this.knownEvents[t] || [], this.knownEvents[t].indexOf("pid") === -1 && this.knownEvents[t].push("pid")), r ? this.validateDataObject(n, i) : (i.event_action = t, n === this.customEvt && i.hasOwnProperty("gtm_tag_source") && (i = this.mapGtmParams(i)), i = this.validateDataObjectNew(n, i)), this.uetConfig.cdl && (i.cdl = this.uetConfig.cdl), n === this.customEvt) {
                s = [];
                for (v in i) s.push(v);
    ...
    this.shouldEnforce = function(n) {
        return this.uetConfig.consent.enabled === !0 || this.uetConfig.tcf.enabled === !0 && this.uetConfig.tcf.hasLoaded === !0 ? !1 : this.uetConfig.cusig.blob.bi === !0 ? !0 : (this.uetConfig.cusig.blob.ec === !0) ? this.uetConfig.cusig.blob.dt === !0 ? !0 : this.uetConfig.cusig.blob.at === !0 ? !1 : n.hasCookie === !1 ? !0 : !1 : !1
    };
    this.enforceConsent = function() {
        var n = this.getCmpData(),
            t = this.uetConfig.consent.enforced;
        this.shouldEnforce(n) ? (this.uetConfig.consent.enabled = !0, this.uetConfig.consent.adStorageAllowed = !1, this.uetConfig.consent.enforced = !0, delete this.beaconParams.sid, delete this.beaconParams.vid, delete this.beaconParams.vids, delete this.beaconParams.msclkid, t !== !0 && this.fireConsentPing("enforced")) : n.hasCookie === !0 && this.uetConfig.consent.enforced === !0 && (this.uetConfig.consent.enabled = !1, this.uetConfig.consent.enforced = !1, t !== !1 && this.fireConsentPing("unenforced"))
    };
    this.addConsentParams = function(n) {
        if (this.uetConfig.consent.enabled === !0 && (n.asc = this.uetConfig.consent.adStorageAllowed ? "G" : "D"), this.uetConfig.tcf.enabled === !0) {
            var t = {
    ...
    this.setUserSignals = function(n) {
        typeof n == "object" && n !== null && (this.uetConfig.cusig.blob = n, this.enforceConsent());
        this.uetConfig.cusig.hasLoaded || (this.uetConfig.cusig.hasLoaded = !0, clearTimeout(this.uetConfig.cusig.timeoutId), this.uetConfig.cusig.timeoutId = null, this.uetLoaded !== !0 && this.checkuetHostdocumentload())
    };
