...
import {
    ...
    STR_ADD_TELEMETRY_INITIALIZERS,
...
import {
    _DYN_AUTO_TRACK_PAGE_VISI5,
    _DYN_CONFIG,
    _DYN_CONTEXT,
    _DYN_CORRELATION_HEADER_E10,
    _DYN_DIAGNOSTIC_LOG_INTER4,
    _DYN_DISABLE_AJAX_TRACKIN6,
    _DYN_DISABLE_CORRELATION_9,
    _DYN_DISABLE_EXCEPTION_TR2,
    _DYN_DISABLE_FLUSH_ON_BEF11,
    _DYN_DISABLE_TELEMETRY,
    _DYN_EMIT_LINE_DELIMITED_3,
    _DYN_ENABLE_CORS_CORRELAT17,
    _DYN_ENABLE_SESSION_STORA13,
    _DYN_ENDPOINT_URL,
    _DYN_IS_BEACON_API_DISABL8,
    _DYN_IS_BROWSER_LINK_TRAC16,
    _DYN_IS_COOKIE_USE_DISABL14,
    _DYN_IS_STORAGE_USE_DISAB15,
...
var AppInsightsDeprecated = /** @class */ (function() {
    function AppInsightsDeprecated(snippet, appInsightsNew) {
        ...
        dynamicProto(AppInsightsDeprecated, this, function(_self) {
            ...
            _self[_DYN_CONTEXT /* @min:%2econtext */ ] = {
                addTelemetryInitializer: _addTelemetryInitializers.bind(_self)
            };
            ...
            _self[STR_TRACK_EVENT /* @min:%2etrackEvent */ ] = function(name, properties, measurements) {
                appInsightsNew[STR_TRACK_EVENT /* @min:%2etrackEvent */ ]({
                    name: name
                });
            };
            ...
            _self[STR_TRACK_METRIC /* @min:%2etrackMetric */ ] = function(name, average, sampleCount, min, max, properties) {
                appInsightsNew[STR_TRACK_METRIC /* @min:%2etrackMetric */ ]({
                    name: name,
                    average: average,
            ...
            _self[STR_TRACK_TRACE /* @min:%2etrackTrace */ ] = function(message, properties, severityLevel) {
                appInsightsNew[STR_TRACK_TRACE /* @min:%2etrackTrace */ ]({
                    message: message,
