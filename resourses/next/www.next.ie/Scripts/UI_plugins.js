...
(function($) {
        ...
        touchEnd: function(e, NXTouchObj) {
            if (methods.Settings.isMouseDown) {
                ...
                if (Math.abs(methods.Settings.startPosition - methods.Settings.endPosition) > methods.Settings.PageWidth / 2) {
                    ...
                    methods.Settings.Pages.animate({
                        "left": distanceDragged
                    }, 300);
    ...
    $.fn.NextCarousel = function(config) {
        ...
        if ($(".NextCarouselWrapper").length) {
            var options = {
                TargetElement: '.NextCarouselWrapper'
            };
        ...
        init: function(options) {
            ...
            $(openButton).click(function() {
                ...
                if (!$(".ProductPage").length) {
                    $("html,body").animate({
                        scrollTop: $(NextSlideWindow).offset().top - $(".PageHeader").height()
                    }, "easeOutCubic");
                }
    ...
    if (typeof settings !== "undefined") {
        switch (settings.align) {
            case 'top':
                ...
                $(dialougue).offset({
                    left: srcOffset.left + customLeftMargin,
                    top: offsetTop + customMarginTop
                });
            ...
            case 'right':
                ...
                $(dialougue).offset({
                    left: offsetLeft + customLeftMargin,
                    top: offsetTop + customMarginTop
                });
