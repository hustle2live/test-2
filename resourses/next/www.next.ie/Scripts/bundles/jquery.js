...
(function(n, t) {
    ...
    function kr(n) {
        ...
        return ur.appendChild(t), t.innerHTML = n.outerHTML, t.firstChild
    }
    ...
    function ni(n) {
        return function(t, r) {
            if (typeof t != "string" && (r = t, t = "*"), i.isFunction(r))
                for (var o = t.toLowerCase().split(cr), f = 0, h = o.length, u, s, e; f < h; f++) u = o[f], e = /^\+/.test(u), e && (u = u.substr(1) || "*"), s = n[u] = n[u] || [], s[e ? "unshift" : "push"](r)
        }
    }

    function b(n, i, r, u, f, e) {
        f = f || i.dataTypes[0];
        e = e || {};
        e[f] = !0;
        for (var s = n[f], h = 0, l = s ? s.length : 0, c = n === ht, o; h < l && (c || !o); h++) o = s[h](i, r, u), typeof o == "string" && (!c || e[o] ? o = t : (i.dataTypes.unshift(o), o = b(n, i, r, u, o, e)));
        return !c && o || e["*"] || (o = b(n, i, r, u, "*", e)), o
    }
    ...
    function nu(n, r) {
        ...
        for (var v = n.dataTypes, s = {}, c, p = v.length, l, u = v[0], h, y, f, e, o, a = 1; a < p; a++) {
            if (a === 1)
                for (c in n.converters) typeof c == "string" && (s[c.toLowerCase()] = n.converters[c]);
            if (h = u, u = v[a], u === "*") u = h;
            else if (h !== "*" && h !== u) {
                if (y = h + " " + u, f = s[y] || s["* " + u], !f) {
                    o = t;
                    for (e in s)
                        if (l = e.split(" "), (l[0] === h || l[0] === "*") && (o = s[l[1] + " " + u], o)) {
                            e = s[e];
                            e === !0 ? f = o : o === !0 && (f = e);
                            break
                        }
    ...
    function ri() {
        return setTimeout(iu, 0), tt = i.now()
    }
    ...
    function c(n, t) {
        var r = {};
        return i.each(pr.concat.apply([], pr.slice(0, t)), function() {
            r[this] = n
        }), r
    }
    ...
    var r = n.document,
        ...
        i = function() {
            ...
            return i.fn = i.prototype = {
                ...
                trim: p ? function(n) {
                    ...
                    return n == null ? "" : n.toString().replace(v, "").replace(y, "")
                },
        ...
        k, ei, oi, si, y, d, hi, l, ci, ft;
    i.Callbacks = function(n) {
        n = n ? fi[n] || wr(n) : {};
        var r = [],
            f = [],
            u, s, c, h, e, l = function(t) {
                for (var u, f, e = 0, s = t.length; e < s; e++) u = t[e], f = i.type(u), f === "array" ? l(u) : f === "function" && (n.unique && o.has(u) || r.push(u))
            },
            a = function(t, i) {
    ...
    i.support = function() {
        var u, y, o, l, a, f, s, e, c, v, p, h, t = r.createElement("div"),
            w = r.documentElement;
        ...
        if (!t.addEventListener && t.attachEvent && t.fireEvent && (t.attachEvent("onclick", function() {
            ...
            for (p in {
                    ...
                    change: 1,
                    focusin: 1
                }) v = "on" + p, h = v in t, h || (t.setAttribute(v, "return;"), h = typeof t[v] == "function"), u[p + "Bubbles"] = h;
        return e.removeChild(t), e = l = a = s = t = f = null, i(function() {
            var f, e, n, p, o, l, a, v, y, w, s = r.getElementsByTagName("body")[0];
    ...
    i.extend({
        ...
        hasData: function(n) {
            return n = n.nodeType ? i.cache[n[i.expando]] : n[i.expando], !!n && !it(n)
        },
            ...
            if (i.acceptData(n)) {
                ...
                if (u[f]) {
                    if (t && (e = r ? u[f] : u[f].data, e)) {
                        ...
                        if (!(r ? it : i.isEmptyObject)(e)) return
                    }(r || (delete u[f].data, it(u[f]))) && (i.support.deleteExpando || !u.setInterval ? delete u[f] : u[f] = null, h && (i.support.deleteExpando ? delete n[o] : n.removeAttribute ? n.removeAttribute(o) : n[o] = null))
                }
            }
        },
        ...
        data: function(n, r) {
            ...
            if (typeof n == "undefined") {
                if (this.length && (f = i.data(this[0]), this[0].nodeType === 1 && !i._data(this[0], "parsedAttrs"))) {
                    for (s = this[0].attributes, o = 0, h = s.length; o < h; o++) e = s[o].name, e.indexOf("data-") === 0 && (e = i.camelCase(e.substring(5)), lt(this[0], e, f[e]));
            ...
            return typeof n == "object" ? this.each(function() {
                i.data(this, n)
            }) : (u = n.split("."), u[1] = u[1] ? "." + u[1] : "", r === t ? (f = this.triggerHandler("getData" + u[1] + "!", [u[0]]), f === t && this.length && (f = i.data(this[0], n), f = lt(this[0], n, f)), f === t && u[1] ? this.data(u[0]) : f) : this.each(function() {
                var t = i(this),
                    f = [u[0], r];
    ...
    i.extend({
        ...
        _unmark: function(n, t, r) {
            if (n !== !0 && (r = t, t = n, n = !1), t) {
                ...
                f ? i._data(t, u, f) : (i.removeData(t, u, !0), at(t, r, "mark"))
            }
        },
        ...
        dequeue: function(n, t) {
            ...
            r.length || (i.removeData(n, t + "queue " + t + ".run", !0), at(n, t, "queue"))
        }
    });
    i.fn.extend({
        queue: function(n, r) {
    ...
    var li = /[\n\t\r]/g,
        ...
        su = /^a(?:rea)?$/i,
        ai = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
        vi = i.support.getSetAttribute,
        e, yi, pi;
    i.fn.extend({
        attr: function(n, t) {
        ...
        removeClass: function(n) {
            ...
            if (n && typeof n == "string" || n === t)
                for (o = (n || "").split(g), u = 0, s = this.length; u < s; u++)
                    if (r = this[u], r.nodeType === 1 && r.className)
                        if (n) {
                            for (f = (" " + r.className + " ").replace(li, " "), e = 0, h = o.length; e < h; e++) f = f.replace(" " + o[e] + " ", " ");
        ...
        hasClass: function(n) {
            for (var i = " " + n + " ", t = 0, r = this.length; t < r; t++)
                if (this[t].nodeType === 1 && (" " + this[t].className + " ").replace(li, " ").indexOf(i) > -1) return !0;
            return !1
        },
        val: function(n) {
            var r, u, e, f = this[0];
            ...
            })) : f ? (r = i.valHooks[f.nodeName.toLowerCase()] || i.valHooks[f.type], r && "get" in r && (u = r.get(f, "value")) !== t) ? u : (u = f.value, typeof u == "string" ? u.replace(fu, "") : u == null ? "" : u) : void 0
        }
    });
    i.extend({
        valHooks: {
        ...
        attr: function(n, r, u, f) {
            ...
            if (n && c !== 3 && c !== 8 && c !== 2) {
                ...
                if (h = c !== 1 || !i.isXMLDoc(n), h && (r = r.toLowerCase(), s = i.attrHooks[r] || (ai.test(r) ? yi : e)), u !== t) {
                    if (u === null) {
                        i.removeAttr(n, r);
                        return
                    }
        ...
        removeAttr: function(n, t) {
            var u, f, r, o, e = 0;
            if (t && n.nodeType === 1)
                for (f = t.toLowerCase().split(g), o = f.length; e < o; e++) r = f[e], r && (u = i.propFix[r] || r, i.attr(n, r, ""), n.removeAttribute(vi ? r : u), ai.test(r) && u in n && (n[u] = !1))
        },
        attrHooks: {
            type: {
                set: function(n, t) {
    ...
    vi || (pi = {
        ...
        get: function(n, i) {
            var r;
            return r = n.getAttributeNode(i), r && (pi[i] ? r.nodeValue !== "" : r.specified) ? r.nodeValue : t
        },
        set: function(n, t, i) {
    ...
    i.event = {
        add: function(n, r, u, f, e) {
            var a, s, v, y, p, o, w, l, b, c, h;
            if (n.nodeType !== 3 && n.nodeType !== 8 && r && u && (a = i._data(n))) {
                for (u.handler && (b = u, u = b.handler), u.guid || (u.guid = i.guid++), v = a.events, v || (a.events = v = {}), s = a.handle, s || (a.handle = s = function(n) {
                        return typeof i != "undefined" && (!n || i.event.triggered !== n.type) ? i.event.dispatch.apply(s.elem, arguments) : t
                    }, s.elem = n), r = i.trim(ki(r)).split(" "), y = 0; y < r.length; y++) p = wi.exec(r[y]) || [], o = p[1], w = (p[2] || "").split(".").sort(), h = i.event.special[o] || {}, o = (e ? h.delegateType : h.bindType) || o, h = i.event.special[o] || {}, l = i.extend({
                    type: o,
                    origType: p[1],
                    data: f,
                    handler: u,
                    ...
                    quick: vu(e),
                    namespace: w.join(".")
                }, b), c = v[o], c || (c = v[o] = [], c.delegateCount = 0, h.setup && h.setup.call(n, f, w, s) !== !1 || (n.addEventListener ? n.addEventListener(o, s, !1) : n.attachEvent && n.attachEvent("on" + o, s))), h.add && (h.add.call(n, l), l.handler.guid || (l.handler.guid = u.guid)), e ? c.splice(c.delegateCount++, 0, l) : c.push(l), i.event.global[o] = !0;
                n = null
            }
        },
        global: {},
        remove: function(n, t, r, u, f) {
            ...
            if (y && (v = y.events)) {
                for (t = i.trim(ki(t || "")).split(" "), l = 0; l < t.length; l++) {
                    if (p = wi.exec(t[l]) || [], e = b = p[1], h = p[2], !e) {
        ...
        trigger: function(r, u, f, e) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                var o = r.type || r,
                    p = [],
                    w, k, c, s, h, a, l, v, y, b;
                if (!bi.test(o + i.event.triggered) && (o.indexOf("!") >= 0 && (o = o.slice(0, -1), k = !0), o.indexOf(".") >= 0 && (p = o.split("."), o = p.shift(), p.sort()), f && !i.event.customEvent[o] || i.event.global[o])) {
                    ...
                    if (r.result = t, r.target || (r.target = f), u = u != null ? i.makeArray(u) : [], u.unshift(r), l = i.event.special[o] || {}, !l.trigger || l.trigger.apply(f, u) !== !1) {
                        if (y = [
                            ...
                            for (b = l.delegateType || o, s = bi.test(b + o) ? f : f.parentNode, h = null; s; s = s.parentNode) y.push([s, b]), h = s;
        ...
        dispatch: function(r) {
            ...
            if (b[0] = r, r.delegateTarget = this, c && !r.target.disabled && !(r.button && r.type === "click"))
                for (v = i(this), v.context = this.ownerDocument || this, e = r.target; e != this; e = e.parentNode || this) {
                    for (p = {}, w = [], v[0] = e, f = 0; f < c; f++) u = h[f], s = u.selector, p[s] === t && (p[s] = u.quick ? yu(e, u.quick) : v.is(s)), p[s] && w.push(u);
                    w.length && l.push({
                        elem: e,
                        matches: w
                    })
            ...
            for (h.length > c && l.push({
                    elem: this,
                    matches: h.slice(c)
                }), f = 0; f < l.length && !r.isPropagationStopped(); f++)
                for (o = l[f], r.currentTarget = o.elem, a = 0; a < o.matches.length && !r.isImmediatePropagationStopped(); a++) u = o.matches[a], (k || !r.namespace && !u.namespace || r.namespace_re && r.namespace_re.test(u.namespace)) && (r.data = u.data, r.handleObj = u, y = ((i.event.special[u.origType] || {}).handle || u.handler).apply(o.elem, b), y !== t && (r.result = y, y === !1 && (r.preventDefault(), r.stopPropagation())));
            return r.result
        },
    ...
    i.Event = function(n, t) {
        ...
        n && n.type ? (this.originalEvent = n, this.type = n.type, this.isDefaultPrevented = n.defaultPrevented || n.returnValue === !1 || n.getPreventDefault && n.getPreventDefault() ? p : h) : this.type = n;
        t && i.extend(this, t);
    ...
    (function() {
        ...
        function k(t, i, r, u, f, o) {
            for (var s, h, c = 0, l = u.length; c < l; c++)
                if (s = u[c], s) {
                    for (h = !1, s = s[t]; s;) {
                        if (s[e] === r) {
                            h = u[s.sizset];
                        ...
                        if (s.nodeType === 1)
                            if (o || (s[e] = r, s.sizset = c), typeof i != "string") {
                                if (s === i) {
                                    h = !0;
                                    break
                                }
        ...
        n = function(t, i, e, o) {
            ...
            if (s.length > 1 && tt.exec(t))
                ...
                for (l = o ? {
                        expr: s.pop(),
                        set: f(o)
                    } : n.find(s.pop(), s.length === 1 && (s[0] === "~" || s[0] === "+") && i.parentNode ? i.parentNode : i, k), a = l.expr ? n.filter(l.expr, l.set) : l.set, s.length > 0 ? h = f(a) : it = !1; s.length;) w = s.pop(), b = w, u.relative[w] ? b = s.pop() : w = "", b == null && (b = i), u.relative[w](h, b, k);
            else h = s = [];
            ...
            return g && (n(g, nt, e, o), n.uniqueSort(e)), e
        };
            ...
            u = n.selectors = {
                ...
                relative: {
                    ...
                    "": function(n, t, i) {
                        var r, f = y++,
                            u = k;
                        typeof t != "string" || l.test(t) || (t = t.toLowerCase(), r = t, u = b);
    ...
    i.fn.extend({
        ...
        not: function(n) {
            return this.pushStack(yt(this, n, !1), "not", n)
        },
        filter: function(n) {
            return this.pushStack(yt(this, n, !0), "filter", n)
        },
        is: function(n) {
        ...
        closest: function(n, t) {
            ...
            for (o = di.test(n) || typeof n != "string" ? i(n, t || this.context) : 0, u = 0, s = this.length; u < s; u++)
                for (r = this[u]; r;)
        ...
        add: function(n, t) {
            ...
            return this.pushStack(vt(u[0]) || vt(r[0]) ? r : i.unique(r))
        },
        andSelf: function() {
    ...
    i.each({
        ...
        i.fn[n] = function(r, u) {
            ...
            return pu.test(n) || (u = r), u && typeof u == "string" && (f = i.filter(u, f)), f = this.length > 1 && !gu[n] ? i.unique(f) : f, (this.length > 1 || bu.test(u)) && wu.test(n) && (f = f.reverse()), this.pushStack(f, n, du.call(arguments).join(","))
        }
    });
    i.extend({
    ...
    var gi = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        nf = / jQuery\d+="(?:\d+|null)"/g,
        ot = /^\s+/,
        nr = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
        tr = /<([\w:]+)/,
        tf = /<tbody/i,
        rf = /<|&#?\w+;/,
        uf = /<(?:script|style)/i,
    ...
    i.fn.extend({
        ...
        html: function(n) {
            ...
            if (typeof n != "string" || uf.test(n) || !i.support.leadingWhitespace && ot.test(n) || u[(tr.exec(n) || ["", ""])[1].toLowerCase()]) i.isFunction(n) ? this.each(function(t) {
                var r = i(this);
        ...
        domManip: function(n, r, u) {
            var c, h, f, o, e = n[0],
                l = [];
            if (!i.support.checkClone && arguments.length === 3 && typeof e == "string" && rr.test(e)) return this.each(function() {
            ...
            if (this[0]) {
                if (o = e && e.parentNode, c = i.support.parentNode && o && o.nodeType === 11 && o.childNodes.length === this.length ? {
                    ...
                    r = r && i.nodeName(h, "tr");
                    for (var s = 0, a = this.length, v = a - 1; s < a; s++) u.call(r ? br(this[s], h) : this[s], c.cacheable || a > 1 && s < v ? i.clone(f, !0, !0) : f)
                }
                l.length && i.each(l, dr)
            }
            return this
        }
    });
    i.buildFragment = function(n, t, u) {
        var e, h, s, o, f = n[0];
        return t && t[0] && (o = t[0].ownerDocument || t[0]), o.createDocumentFragment || (o = r), n.length === 1 && typeof f == "string" && f.length < 512 && o === r && f.charAt(0) === "<" && !ff.test(f) && (i.support.checkClone || !rr.test(f)) && (i.support.html5Clone || !ir.test(f)) && (h = !0, s = i.fragments[f], s && s !== 1 && (e = s)), e || (e = o.createDocumentFragment(), i.clean(n, o, e, u)), h && (i.fragments[f] = s ? e : 1), {
            fragment: e,
            cacheable: h
        }
    };
    ...
    i.extend({
        clone: function(n, t, r) {
            var f, e, u, o = i.support.html5Clone || !ir.test("<" + n.nodeName) ? n.cloneNode(!0) : kr(n);
            if ((!i.support.noCloneEvent || !i.support.noCloneChecked) && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n))
                for (bt(n, o), f = w(n), e = w(o), u = 0; f[u]; ++u) e[u] && bt(f[u], e[u]);
            if (t && (wt(n, o), r))
                for (f = w(n), e = w(o), u = 0; f[u]; ++u) wt(f[u], e[u]);
            return f = e = null, o
        },
        clean: function(n, t, f, e) {
            var p, s, c, h, o, y, a, w, b;
            for (t = t || r, typeof t.createElement == "undefined" && (t = t.ownerDocument || t[0] && t[0].ownerDocument || r), s = [], h = 0;
                ...
                if (typeof o == "number" && (o += ""), o) {
                    if (typeof o == "string")
                        if (rf.test(o)) {
                            o = o.replace(nr, "<$1><\/$2>");
                            var k = (tr.exec(o) || ["", ""])[1].toLowerCase(),
                                v = u[k] || u._default,
                                d = v[0],
                                l = t.createElement("div");
                            for (t === r ? ur.appendChild(l) : pt(t).appendChild(l), l.innerHTML = v[1] + o + v[2]; d--;) l = l.lastChild;
                            if (!i.support.tbody)
                                for (y = tf.test(o), a = k === "table" && !y ? l.firstChild && l.firstChild.childNodes : v[1] === "<table>" && !y ? l.childNodes : [], c = a.length - 1; c >= 0; --c) i.nodeName(a[c], "tbody") && !a[c].childNodes.length && a[c].parentNode.removeChild(a[c]);
                            !i.support.leadingWhitespace && ot.test(o) && l.insertBefore(t.createTextNode(ot.exec(o)[0]), l.firstChild);
                            o = l.childNodes
                        } else o = t.createTextNode(o);
                    if (!i.support.appendChecked)
                        if (o[0] && typeof(w = o.length) == "number")
                            for (c = 0; c < w; c++) dt(o[c]);
                        else dt(o);
            ...
            if (f)
                for (p = function(n) {
                    ...
                    }, h = 0; s[h]; h++) e && i.nodeName(s[h], "script") && (!s[h].type || s[h].type.toLowerCase() === "text/javascript") ? e.push(s[h].parentNode ? s[h].parentNode.removeChild(s[h]) : s[h]) : (s[h].nodeType === 1 && (b = i.grep(s[h].getElementsByTagName("script"), p), s.splice.apply(s, [h + 1, 0].concat(b))), f.appendChild(s[h]));
            return s
        },
        cleanData: function(n) {
            for (var u, r, f, e = i.cache, s = i.event.special, h = i.support.deleteExpando, o = 0, t;
                (t = n[o]) != null; o++)
    ...
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                var f;
                if (r) return n.offsetWidth !== 0 ? gt(n, t, u) : (i.swap(n, af, function() {
                    f = gt(n, t, u)
                }), f)
            },
            set: function(n, t) {
    ...
    r.defaultView && r.defaultView.getComputedStyle && (er = function(n, t) {
        var r, u, f;
        return t = t.replace(hf, "-$1").toLowerCase(), (u = n.ownerDocument.defaultView) && (f = u.getComputedStyle(n, null)) && (r = f.getPropertyValue(t), r !== "" || i.contains(n.ownerDocument.documentElement, n) || (r = i.style(n, t))), r
    });
    r.documentElement.currentStyle && (or = function(n, t) {
        var f, u, e, i = n.currentStyle && n.currentStyle[t],
            r = n.style;
        return i === null && r && (e = r[t]) && (i = e), !fr.test(i) && cf.test(i) && (f = r.left, u = n.runtimeStyle && n.runtimeStyle.left, u && (n.runtimeStyle.left = n.currentStyle.left), r.left = t === "fontSize" ? "1em" : i || 0, i = r.pixelLeft + "px", r.left = f, u && (n.runtimeStyle.left = u)), i === "" ? "auto" : i
    });
    a = er || or;
    ...
    i.extend({
        ...
        ajaxSetup: function(n, t) {
            return t ? ti(n, i.ajaxSettings) : (t = n, n = i.ajaxSettings), ti(n, t), n
        },
        ajaxSettings: {
            url: o,
        ...
        ajax: function(n, r) {
            function y(n, r, s, l) {
                if (e !== 2) {
                    ...
                    if (n >= 200 && n < 300 || n === 304)
                        if (u.ifModified && ((k = f.getResponseHeader("Last-Modified")) && (i.lastModified[o] = k), (d = f.getResponseHeader("Etag")) && (i.etag[o] = d)), n === 304) a = "notmodified", y = !0;
                        else try {
                            b = nu(u, ut);
                            a = "success";
                            y = !0
                    ...
                    f.status = n;
                    f.statusText = "" + (r || a);
                    y ? nt.resolveWith(h, [b, a, f]) : nt.rejectWith(h, [f, a, w]);
                    f.statusCode(p);
                    p = t;
                    v && g.trigger("ajax" + (y ? "Success" : "Error"), [f, u, y ? b : w]);
                    rt.fireWith(h, [f, a]);
            ...
            var u = i.ajaxSetup({}, r),
                ...
                v, a, f = {
                    ...
                    getResponseHeader: function(n) {
                        ...
                        if (e === 2) {
                            if (!w)
                                for (w = {}; i = kf.exec(tt);) w[i[1].toLowerCase()] = i[2];
                            i = w[n.toLowerCase()]
                        }
                        return i === t ? null : i
                    },
            ...
            if (nt.promise(f), f.success = f.done, f.error = f.fail, f.complete = rt.add, f.statusCode = function(n) {
                    ...
                    return this
                }, u.url = ((n || u.url) + "").replace(bf, "").replace(ne, s[1] + "//"), u.dataTypes = i.trim(u.dataType || "*").toLowerCase().split(cr), u.crossDomain == null && (l = lr.exec(u.url.toLowerCase()), u.crossDomain = !!(l && (l[1] != s[1] || l[2] != s[2] || (l[3] || (l[1] === "http:" ? 80 : 443)) != (s[3] || (s[1] === "http:" ? 80 : 443))))), u.data && u.processData && typeof u.data != "string" && (u.data = i.param(u.data, u.traditional)), b(ht, u, r, f), e === 2) return !1;
            v = u.global;
            u.type = u.type.toUpperCase();
            u.hasContent = !gf.test(u.type);
            v && i.active++ == 0 && i.event.trigger("ajaxStart");
            u.hasContent || (u.data && (u.url += (hr.test(u.url) ? "&" : "?") + u.data, delete u.data), o = u.url, u.cache === !1 && (k = i.now(), d = u.url.replace(re, "$1_=" + k), u.url = d + (d === u.url ? (hr.test(u.url) ? "&" : "?") + "_=" + k : "")));
            ...
            if (c = b(vr, u, r, f), c) {
                ...
                u.async && u.timeout > 0 && (it = setTimeout(function() {
                    f.abort("timeout")
                }, u.timeout));
                try {
                    e = 1;
    ...
    i.ajaxPrefilter("json jsonp", function(t, r, u) {
        ...
        if (t.dataTypes[0] === "jsonp" || t.jsonp !== !1 && (y.test(t.url) || h && y.test(t.data))) {
            var o, f = t.jsonpCallback = i.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                ...
                s = t.data,
                l = "$1" + f + "$2";
            return t.jsonp !== !1 && (e = e.replace(y, l), t.url === e && (h && (s = s.replace(y, l)), t.data === s && (e += (/\?/.test(e) ? "&" : "?") + t.jsonp + "=" + f))), t.url = e, t.data = s, n[f] = function(n) {
                o = [n]
            }, u.always(function() {
                n[f] = c;
        ...
        if (!r.crossDomain || i.support.cors) {
            ...
            return {
                send: function(f, e) {
                    ...
                    u = function(n, f) {
                        ...
                        try {
                            if (u && (f || o.readyState === 4))
                                if (u = t, h && (o.onreadystatechange = i.noop, d && delete l[h]), f) o.readyState !== 4 && o.abort();
                                else {
                                    s = o.status;
                    ...
                    r.async && o.readyState !== 4 ? (h = ++hi, d && (l || (l = {}, i(n).unload(d)), l[h] = u), o.onreadystatechange = u) : u()
                },
                abort: function() {
                    u && u(0, 1)
                }
    ...
    i.fn.extend({
        show: function(n, t, r) {
            ...
            for (f = 0, o = this.length; f < o; f++) u = this[f], u.style && (e = u.style.display, i._data(u, "olddisplay") || e !== "none" || (e = u.style.display = ""), e === "" && i.css(u, "display") === "none" && i._data(u, "olddisplay", ui(u.nodeName)));
        ...
        animate: function(n, t, r, u) {
            function e() {
                ...
                for (r in n) {
                    ...
                    y && (e === "height" || e === "width") && (u.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], i.css(this, "display") === "inline" && i.css(this, "float") === "none" && (i.support.inlineBlockNeedsLayout && ui(this.nodeName) !== "inline" ? this.style.zoom = 1 : this.style.display = "inline-block"))
                }
                u.overflow != null && (this.style.overflow = "hidden");
                for (r in n) o = new i.fx(this, u, r), t = n[r], ue.test(t) ? (a = i._data(this, "toggle" + r) || (t === "toggle" ? v ? "show" : "hide" : 0), a ? (i._data(this, "toggle" + r, a === "show" ? "hide" : "show"), o[a]()) : o[t]()) : (h = fe.exec(t), s = o.cur(), h ? (c = parseFloat(h[2]), l = h[3] || (i.cssNumber[r] ? "" : "px"), l !== "px" && (i.style(this, r, (c || 1) + l), s = (c || 1) / o.cur() * s, i.style(this, r, s + l)), h[1] && (c = (h[1] === "-=" ? -1 : 1) * c + s), o.custom(s, c, l)) : o.custom(s, t, ""));
                return !0
            }
            var f = i.speed(t, r, u);
    ...
    i.fn.offset = "getBoundingClientRect" in r.documentElement ? function(n) {
        ...
        for (var r, h = t.offsetParent, a = t, c = t.ownerDocument, l = c.documentElement, e = c.body, s = c.defaultView, o = s ? s.getComputedStyle(t, null) : t.currentStyle, u = t.offsetTop, f = t.offsetLeft;
            ...
            u -= t.scrollTop;
            f -= t.scrollLeft;
            t === h && (u += t.offsetTop, f += t.offsetLeft, !i.support.doesNotAddBorder || i.support.doesAddBorderForTableAndCells && ci.test(t.nodeName) || (u += parseFloat(r.borderTopWidth) || 0, f += parseFloat(r.borderLeftWidth) || 0), a = h, h = t.offsetParent);
        ...
        return (o.position === "relative" || o.position === "static") && (u += e.offsetTop, f += e.offsetLeft), i.support.fixedPosition && o.position === "fixed" && (u += Math.max(l.scrollTop, e.scrollTop), f += Math.max(l.scrollLeft, e.scrollLeft)), {
            top: u,
            left: f
        }
    };
    ...
    i.each(["Left", "Top"], function(n, r) {
        ...
        i.fn[u] = function(r) {
            var e, f;
            return r === t ? (e = this[0], !e) ? null : (f = ut(e), f ? "pageXOffset" in f ? f[n ? "pageYOffset" : "pageXOffset"] : i.support.boxModel && f.document.documentElement[u] || f.document.body[u] : e[u]) : this.each(function() {
                f = ut(this);
