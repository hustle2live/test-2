! function(e) {
    ...
    ! function(t) {
        ...
        function r(t, n, e, r) {
            ...
            if ("undefined" != typeof ArrayBuffer && n instanceof ArrayBuffer) {
                ...
                return o = void 0 === u && void 0 === r ? new Uint8Array(o) : void 0 === r ? new Uint8Array(o, u) : new Uint8Array(o, u, r), h.TYPED_ARRAY_SUPPORT ? (i = o).__proto__ = h.prototype : i = s(i, o), i
            }
            if ("string" != typeof n) {
                u = t, r = n;
                if (h.isBuffer(r)) return o = 0 | c(r.length), 0 !== (u = f(u, o)).length && r.copy(u, 0, 0, o), u;
                if (r) {
                    if ("undefined" != typeof ArrayBuffer && r.buffer instanceof ArrayBuffer || "length" in r) return "number" != typeof r.length || function(t) {
                        return t != t
                    }(r.length) ? f(u, 0) : s(u, r);
                    if ("Buffer" === r.type && a(r.data)) return s(u, r.data)
                }
                throw new TypeError("First argument must be a string, Buffer, ArrayBuffer, Array, or array-like object.")
            }
            i = t, r = n, t = e;
            if (h.isEncoding(t = "string" == typeof t && "" !== t ? t : "utf8")) return n = 0 | l(r, t), i = (r = (i = f(i, n)).write(r, t)) !== n ? i.slice(0, r) : i;
        ...
        function u(t, n) {
            if (i(n), t = f(t, n < 0 ? 0 : 0 | c(n)), !h.TYPED_ARRAY_SUPPORT)
            ...
            for (t = t || "utf8";;) switch (t) {
                case "hex":
                    var o = this,
                        ...
                        f = o.length;
                    (!a || a < 0 || f < a) && (a = f);
                    for (var s = "", c = u = !u || u < 0 ? 0 : u; c < a; ++c) s += function(t) {
                ...
                case "ascii":
                    ...
                    for (var v = f; v < l; ++v) d += String.fromCharCode(127 & h[v]);
                    return d;
                case "latin1":
                case "binary":
                    var y = this,
        ...
        function y(t, n, e, r, i) {
            ...
            if (i)
                for (var s = -1, c = e; c < u; c++)
                    if (f(t, c) === f(n, -1 === s ? 0 : c - s)) {
                        if (c - (s = -1 === s ? c : s) + 1 === a) return s * o
                    } else -1 !== s && (c -= c - s), s = -1;
            else
            ...
            for (var r = [], i = n; i < e;) {
                ...
                if (i + h <= e) switch (h) {
                    case 1:
                        ...
                        break;
                    case 2:
                        128 == (192 & (o = t[i + 1])) && 127 < (f = (31 & s) << 6 | 63 & o) && (c = f);
                        break;
                    case 3:
                        o = t[i + 1], u = t[i + 2], 128 == (192 & o) && 128 == (192 & u) && 2047 < (f = (15 & s) << 12 | (63 & o) << 6 | 63 & u) && (f < 55296 || 57343 < f) && (c = f);
                        break;
                    case 4:
                        o = t[i + 1], u = t[i + 2], a = t[i + 3], 128 == (192 & o) && 128 == (192 & u) && 128 == (192 & a) && 65535 < (f = (15 & s) << 18 | (63 & o) << 12 | (63 & u) << 6 | 63 & a) && f < 1114112 && (c = f)
                }
        ...
        x.Buffer = h, x.SlowBuffer = function(t) {
            ...
            return r = null, n = n, e = e, i(t = t), !(t <= 0) && void 0 !== n ? "string" == typeof e ? f(r, t).fill(n, e) : f(r, t).fill(n) : f(r, t);
            var r
            ...
            if (e <= n) return 1;
            if (this === t) return 0;
            for (var o = (i >>>= 0) - (r >>>= 0), u = (e >>>= 0) - (n >>>= 0), a = Math.min(o, u), f = this.slice(r, i), s = t.slice(n, e), c = 0; c < a; ++c)
                if (f[c] !== s[c]) {
                    o = f[c], u = s[c];
                    break
                }
            ...
            r = r || "utf8";
            for (var o, u, a, f = !1;;) switch (r) {
                case "hex":
                    var s = this,
                        c = t,
                        h = n,
                        l = e,
                        d = (h = Number(h) || 0, s.length - h);
    ...
    ! function(f) {
        function t(t, n) {
            this.g = new f(t), this._ = n, this.S = t, this.A = 0, this.O = 0
        }
    ...
    for (var o = 0, u = Object.entries(i.LIST); o < u.length; o++) {
        var a = e(u[o], 2),
            f = a[0],
            a = a[1];
        "true" === new URLSearchParams(window.location.search).get(a.uri) && (i.LIST[f].chance = 100)
    }
    ...
    o.getParameterFromURI = function(t) {
        ...
        return null == t || "" === (t = t.toString().trim().toLowerCase()) || u.test(t) || f.test(t) || s.test(t) ? t : e(13)("sha256").update(t).digest("hex")
    ...
    ! function(n) {
        ...
        t(i, e), i.prototype.init = function() {
            ...
            for (var n, e = this.K, r = 0 | this.P, i = 0 | this.L, o = 0 | this.D, u = 0 | this.M, a = 0 | this.U, f = 0 | this.B, s = 0 | this.G, c = 0 | this.F, h = 0; h < 16; ++h) e[h] = t.readInt32BE(4 * h);
            for (; h < 64; ++h) e[h] = 0 | (((n = e[h - 2]) >>> 17 | n << 15) ^ (n >>> 19 | n << 13) ^ n >>> 10) + e[h - 7] + (((n = e[h - 15]) >>> 7 | n << 25) ^ (n >>> 18 | n << 14) ^ n >>> 3) + e[h - 16];
            for (var l = 0; l < 64; ++l) var d = c + ((a >>> 6 | a << 26) ^ (a >>> 11 | a << 21) ^ (a >>> 25 | a << 7)) + (s ^ a & (f ^ s)) + y[l] + e[l] | 0,
                ...
                i = r,
                r = d + v | 0;
            this.P = r + this.P | 0, this.L = i + this.L | 0, this.D = o + this.D | 0, this.M = u + this.M | 0, this.U = a + this.U | 0, this.B = f + this.B | 0, this.G = s + this.G | 0, this.F = c + this.F | 0
    ...
    ! function(n) {
        ...
        t(i, e), i.prototype.init = function() {
            ...
            for (var n = this.K, e = 0 | this.$, r = 0 | this.J, i = 0 | this.V, o = 0 | this.H, u = 0 | this.q, a = 0 | this.Y, f = 0 | this.Z, s = 0 | this.W, c = 0 | this.X, h = 0 | this.tt, l = 0 | this.nt, d = 0 | this.et, v = 0 | this.rt, y = 0 | this.it, w = 0 | this.ot, m = 0 | this.ut, p = 0; p < 32; p += 2) n[p] = t.readInt32BE(4 * p), n[p + 1] = t.readInt32BE(4 * p + 4);
            for (; p < 160; p += 2) {
                var b = n[p - 30],
                    g = n[p - 30 + 1],
            ...
            for (var R = 0; R < 160; R += 2) {
                ...
                var D = F(e, r, i),
                    ...
                    P = G(v, y, w),
                    x = m + x | 0,
                    K = (T = (((s + T + J(x, m) | 0) + K + J(x = x + P | 0, P) | 0) + B[R] + J(x = x + k | 0, k) | 0) + I + J(x = x + C | 0, C) | 0, N + M | 0),
                    P = U + D + J(K, N) | 0,
                    s = f,
                    m = w,
                    f = a,
            ...
            this.X = this.X + c | 0, this.tt = this.tt + h | 0, this.nt = this.nt + l | 0, this.et = this.et + d | 0, this.rt = this.rt + v | 0, this.it = this.it + y | 0, this.ot = this.ot + w | 0, this.ut = this.ut + m | 0, this.$ = this.$ + e + J(this.X, c) | 0, this.J = this.J + r + J(this.tt, h) | 0, this.V = this.V + i + J(this.nt, l) | 0, this.H = this.H + o + J(this.et, d) | 0, this.q = this.q + u + J(this.rt, v) | 0, this.Y = this.Y + a + J(this.it, y) | 0, this.Z = this.Z + f + J(this.ot, w) | 0, this.W = this.W + s + J(this.ut, m) | 0
        }, i.prototype.C = function() {
            var r = new n(64);
    ...
    var f = {},
        s = e(3);
    f.LOG = e(4);
    f.cookiesAvailable = !0, f.FP_COOKIES = {
        EPIK: "_epik",
        DERIVED_EPIK: "_derived_epik",
        UNAUTH: "_pin_unauth",
        NCCAPI_URL: "_nccapi_url"
    }, f.writeCookie = function(t, n, e) {
        if (s.isInRampPercentage(s.LIST.CHECK_DOCUMENT_COOKIE.chance)) {
            if (!f.cookiesAvailable) return;
            try {
                document.cookie
            } catch (t) {
                return f.LOG.info("document.cookie not available", t), void(f.cookiesAvailable = !1)
            }
        }
        ...
        try {
            ...
            f.LOG.error("Failed to write cookie", t)
        }
    }, f.getCookies = function() {
        var n = {};
        if (s.isInRampPercentage(s.LIST.CHECK_DOCUMENT_COOKIE.chance)) {
            if (!f.cookiesAvailable) return n;
            try {
                document.cookie
            } catch (t) {
                return f.LOG.info("document.cookie not available", t), f.cookiesAvailable = !1, n
            }
        }
        try {
            ...
            f.LOG.error("Failed to get cookies", t)
        }
        return n
    }, f.deleteCookie = function(t) {
        f.writeCookie(t, "", new Date(0))
    }, f.dropCookie = function(t, n) {
        var e;
        n && "empty" !== n && ((e = new Date).setDate(e.getDate() + 365), f.writeCookie(t, n, e))
    }, f.readCookie = function(t) {
        return (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : f.getCookies())[t]
    }, t.exports = f
}, function(t, n) {
    ...
    function A() {
        ...
        var u = {},
            t = Object.prototype,
            f = t.hasOwnProperty,
            s = Object.defineProperty || function(t, n, e) {
                t[n] = e.value
            },
            ...
            return s(n, "_invoke", {
                value: (i = t, o = e, u = r, a = "suspendedStart", function(t, n) {
                    ...
                    for (u.method = t, u.arg = n;;) {
                        ...
                        if ("next" === u.method) u.sent = u.ft = u.arg;
        ...
        var n = {},
            ...
            y = y && y(y(E([]))),
            w = (y && y !== t && f.call(y, r) && (n = y), v.prototype = l.prototype = Object.create(n));
                ...
                value: function(e, r) {
                    function t() {
                        return new a(function(t, n) {
                            ! function n(t, e, r, i) {
                                var o, t = c(u[t], u, e);
                                if ("throw" !== t.type) return (e = (o = t.arg).value) && "object" == O(e) && f.call(e, "__await") ? a.resolve(e.st).then(function(t) {
                                    n("next", t, r, i)
                                }, function(t) {
                                    n("throw", t, r, i)
        ...
        return s(w, "constructor", {
            ...
            constructor: _,
            reset: function(t) {
                if (this.prev = 0, this.next = 0, this.sent = this.ft = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(g), !t)
                    for (var n in this) "t" === n.charAt(0) && f.call(this, n) && !isNaN(+n.slice(1)) && (this[n] = void 0)
            },
            stop: function() {
                this.done = !0;
    ...
    var d = {},
        f = (d.ct = t(4), window.pintrk && (window.pintrk.mh = "babde0ae", d.ct.setVersion(window.pintrk.mh)), d.ht = t(3), t(5)),
        s = t(8),
        z = (d.lt = f.createUriWithQueryParamaters, d.getCookies = s.getCookies, d.dt = t(22), d.vt = t(23), t(24)),
        $ = t(25).v4,
        v = "sessionStorage",
        o = "localStorage",
        J = "dep",
        ...
        q = "Pinterest Tag Warning: ",
        t = "https://ct.pinterest.com",
        Y = t + "/md/",
        Z = (t = d.ht.isInRampPercentage(d.ht.LIST.SEND_TO_STAGING.chance) ? "https://ct-staging-us.pinterest.com" : t) + "/v3/",
        W = t + "/user/",
        X = "cb",
        Q = "event",
        t = "aem_country",
        ...
        it = ["aem_ge"],
        ot = ["aem_db"],
        ut = ["aem_ct", "aem_st", "aem_zp", t],
        at = [tt],
        ft = "em",
        st = ["fn", "ln", "ph", "ge", "db", "ct", "st", "zp", "country", "external_id"],
        ct = ["event_id", "eid", "eventID"],
        ht = "external_id",
        lt = "aem_external_id",
        dt = "checkout",
        vt = ["pagevisit", "viewcategory", "search", "addtocart", dt, "watchvideo", "signup", "lead", "custom", "externalmeasurement"],
        y = s.FP_COOKIES,
        w = {
            EPIK: "_epik_ls",
        ...
        mt = "Epik",
        i = "epik_localstore",
        pt = "epik_ls_expiry_ms",
        bt = "pin_unauth",
        gt = "Pin-Unauth",
        _t = "Content-Type",
        u = "is_eu",
        Et = ["load", "page", "set", "track", "setConsent", "md"],
        St = "input[type=email],input[type=username],input[type=userid],input[name=username],input[name=userid],input[autocomplete=username],input[autocomplete=userid],input[autocomplete=email]",
        At = /^https?:\/\/.*\.(pinterest|pinterdev)\.com$/i,
        Ot = /^[\w.!#$%&'*+\-\/=?\^`{|}~]+@[a-z\d\-]+(\.[a-z\d\-]+)+$/i,
        jt = /(.+)/,
        Ct = /^[0-9 \-+\(\)\/]*$/,
        It = /^[0-9\- ]*$/,
        p = /(.+)/,
        Rt = /checkouts\/(.+)\/(thank_you|post_purchase)/,
        Nt = /(spf-test-page)|(test\/ct\/.*spf-t)/,
        b = (d.wt = JSON && JSON.stringify, d.bt = !0, "aemEnabled"),
        g = "aemFnLnEnabled",
        Tt = "aemPhEnabled",
        _ = "aemLocEnabled",
        xt = "ct_epik_iframe_enabled",
        kt = "md_frequency",
        Kt = "chrome_new_user_agent_enabled",
        E = {
    ...
    function $t(t) {
        var n;
        (t.origin === window.origin || At.test(t.origin)) && (n = t.data) && "PINTEREST_TAG_TEST" === n.type && t.source.postMessage({
    ...
    function C(t, n, e, r, i) {
        e = e || s.readCookie(n, t) || Qt(r);
        e && K(F({}, i, i === ht ? f.hashParam(e) : e))
    }

    function Vt(t) {
        var n, e;
        window.pintrk.cookieLoaded || (window.pintrk.cookieLoaded = !0, n = s.getCookies(), I() ? (e = f.getParameterFromURI("epik") || s.readCookie(y.EPIK, n), C(n, y.EPIK, e, w.EPIK, "epik"), e && (s.dropCookie(y.EPIK, e), Xt(w.EPIK, e)), C(n, y.UNAUTH, null, w.UNAUTH, bt), e = Object.assign({}, t), window.pintrk.partnerData && (e.pd = window.pintrk.partnerData), T(e, [x, d.gt], d.yt.PAGE_LOAD), C(n, y.DERIVED_EPIK, null, w.DERIVED_EPIK, wt), t = window.location.pathname, (Nt.test(t) || window.pintrk.partnerData && "shopify" === window.pintrk.partnerData.np) && C(n, "_shopify_y", null, null, ht)) : Wt())
    }
        ...
        if (k() && !N()) {
            ...
            if (n) {
                ...
                try {
                    for (r.s(); !(e = r.n()).done;) {
                        var i = e.value;
                        !d.dt.getItem(i) || i in Object.values(y) || n.setItem(i, d.dt.getItem(i))
                    }
                } catch (t) {
                    r.e(t)
                } finally {
    ...
    function R() {
        var t, n = h(Object.values(y).concat(Object.values(w)));
        try {
            for (n.s(); !(t = n.n()).done;) Zt(t.value)
        } catch (t) {
            n.e(t)
        } finally {
            n.f()
    ...
    function Wt() {
        ...
        var t = d._t(v);
        if (t) {
            for (var n = 0, e = Object.values(m); n < e.length; n++) {
                var r = e[n];
                t.removeItem(r)
            }
            t.removeItem(u)
    ...
    function N() {
        var t;
        return null != d.St.isEu ? d.St.isEu : !(t = d._t(v)) || f.toBooleanTypeDefaultTrue(t.getItem(u))
    }
    ...
    function T(t, n, e, r) {
        var i, o, u = 2 < arguments.length && void 0 !== e ? e : d.yt.UNSPECIFIED,
            ...
            f = t,
            u = (f[X] = d.At(), f[J] = "".concat(u.toString(), ",").concat((i = d.yt, o = u, Object.keys(i).filter(function(t) {
                return i[t] === o
            }))[0]), a && (f[V.SKIP_TAG_CONFIG] = !0), d.lt(W, d.Ot(f)));
        d.jt(u, !0, n)
    }

    function x() {
        window.pintrk.derivedCalled && s.readCookie(y.DERIVED_EPIK) || (window.pintrk.derivedCalled = !0, s.dropCookie(y.DERIVED_EPIK, this.getResponseHeader(mt)), Xt(w.DERIVED_EPIK, this.getResponseHeader(mt)), C(s.getCookies(), y.DERIVED_EPIK, null, w.DERIVED_EPIK, wt))
    }

    function k() {
        return "boolean" == typeof Ft ? Ft : Ft = d.ht.isInRampPercentage(d.ht.LIST.FP_LOCAL_STORAGE.chance)
    }

    function Xt(t, n) {
        k() && t && n && "empty" !== n && !N() && (Ht() ? qt(t, n) : R())
    }
    ...
    function tn(t, n) {
        return t && n ? yt.COOKIE_AND_LOCAL_STORAGE : t ? yt.COOKIE_ONLY : n ? yt.LOCAL_STORAGE_ONLY : null
    }

    function K(t) {
        for (var n in t) {
            var e;
            (n === ht || n === lt) && nn(t, n) && nn(window.pintrk.partnerData, n) && (t[n] = en(t[n]), window.pintrk.partnerData[n] = en(window.pintrk.partnerData[n]), e = new Set([].concat(G(t[n]), G(window.pintrk.partnerData[n]))), t[n] = Array.from(e))
        }
    ...
    function un(t) {
        if (t && "object" === O(t)) {
            rn(t), a = t, st.forEach(function(t) {
                t in a && (a[t] = f.hashParam(a[t]))
            });
            var n, e = t[xt],
                r = (void 0 !== e && (an(e), delete t[xt]), t),
                i = h(S);
            try {
                for (i.s(); !(n = i.n()).done;) {
                    var o = n.value,
                        u = r[o.pdConfigKey];
                    void 0 !== u && (sn(o.tagConfigKey, u, o.pdKeyList), P(o.pdConfigKey), delete r[o.pdConfigKey])
                }
            } catch (t) {
                i.e(t)
            } finally {
            ...
            var e = t[kt],
                e = (void 0 !== e && (j(kt, e, "number"), d.St.mdFrequency = e, delete t[kt]), t[Kt]);
            void 0 !== e && (e = f.toBooleanType(e), d.St.chromeNewUserAgentEnabled = e, delete t[Kt]), K(t)
        }
        var a
    }
    ...
    function an(t) {
        t = f.toBooleanType(t);
        (d.St.ctEpikIframeEnabled = t) ? (window.addEventListener("message", d.Ct), "complete" === document.readyState ? fn() : window.addEventListener("load", fn)) : (P(i), P(pt))
    }
                ...
                try {
                    for (u.s(); !(i = u.n()).done;) {
                        ...
                        try {
                            for (s.s(); !(a = s.n()).done;) {
                                var c = a.value;
                                "input" === t ? on(o.name, c.fieldRegex) && L(o.value, c, f.tagConfigKey) : "select" === t && c.selectScrapingEnabled && on(o.name, c.fieldRegex) && L(o.value, c, f.tagConfigKey)
                            }
                        } catch (t) {
                            s.e(t)
                        } finally {
    ...
    function L(t, n, e) {
        t && "string" == typeof t && n.valueRegex.test(t.trim().toLowerCase()) && (n.normalizationRegex && (t = t.replace(n.normalizationRegex, "")), t = f.hashParam(t.trim().toLowerCase()), d.St[e] && ((pdKeyObject = {})[n.pdKey] = t, K(pdKeyObject)), (e = window.pintrk.partnerData && window.pintrk.partnerData.aem_eligible_list ? window.pintrk.partnerData.aem_eligible_list : []).push(n.aemEligibleKey), K({
    ...
    function hn(t) {
        ...
        try {
            for (e.s(); !(n = e.n()).done;) {
                var r = n.value,
                    i = r.tagConfigKey;
                void 0 === d.St[i] && sn(i, t[i], r.pdKeyList)
            }
        } catch (t) {
            e.e(t)
        } finally {
    ...
    function ln() {
        var t, n = h(document.querySelectorAll(St));
        try {
    ...
    function D(t, n, e, r, i) {
        t && t[e] && ((pdKeyObject = {})[r.pdKey] = f.hashParam(n.trim().toLowerCase()), K(pdKeyObject)), -1 === i.indexOf(r.aemEligibleKey) && i.push(r.aemEligibleKey)
    }
    d.St = {
        aemEnabled: void 0,
        ...
        for (var t = 0, n = Object.values(y); t < n.length; t++) {
            var e = n[t];
            s.deleteCookie(e)
        }
    }, d.It = function() {
        var t = this.getResponseHeader(_t);
        ...
        s.dropCookie(y.UNAUTH, this.getResponseHeader(gt)), Xt(w.UNAUTH, this.getResponseHeader(gt)), C(s.getCookies(), y.UNAUTH, this.getResponseHeader(gt), w.UNAUTH, bt);
        var t = this.getResponseHeader(_t);
        if (t && t.includes("application/json")) {
            t = {};
            try {
            ...
            if (d.St.tagConfigsReceived = !0, d.ht.isInRampPercentage(d.ht.LIST.SCRAPE_LISTENERS.chance) && !window.pintrk.setupEmailListeners) {
                ...
                var r, i = h(document.querySelectorAll(St));
                try {
                    for (i.s(); !(r = i.n()).done;) r.value.addEventListener("change", function(t) {
                        L(t.target.value, E, b), I() && window.pintrk.partnerData && window.pintrk.partnerData.aem && !s.readCookie(y.DERIVED_EPIK) && T({
                            pd: {
        ...
        if ("https://ct.pinterest.com" == t.origin && "_epik_localstore" === t.data.key) {
            if (t.data.value) {
                ...
                var e, t = n.expiry || 0,
                    n = n.value;
                t > (new Date).getTime() && n && ((e = {})[i] = n, e[pt] = t + "", K(e))
            }
        ...
        if (window.pintrk && window.pintrk.queue) {
            ...
            if (t.push === Array.prototype.push) {
                function n(t) {
                    ...
                    } else console.info(c + "'%s' is not a supported pintrk command. Expected one of [%s]", n, Et.toString())
                }
                for (var e = t.length, r = 0; r < e; r++) n(t.shift());
                t.push = n, window !== window.parent && window.addEventListener("message", $t)
            }
        }
    }, d.load = function(t) {
        var n, t = l(t, 2),
            e = t[0],
            t = t[1],
            e = ((e = Jt(e)) && (window.pintrk.tagId && console.info(c + "'load' command was called multiple times.  Previously for tag id '%s', now for tag id '%s'.", window.pintrk.tagId, e), window.pintrk.tagId = e), un(t), !N() && I() && Ht() && ! function(t) {
                var n = 0 < arguments.length && void 0 !== t ? t : s.getCookies();
                if (k())
                    for (var e = 0, r = Object.keys(y); e < r.length; e++) {
                        var i = r[e],
                            o = y[i],
                            u = !!n[o],
                            a = !!Qt(w[i]);
                        switch (o) {
                            case y.EPIK:
                                d.St.epikDataSource = tn(u, a);
                                break;
                            case y.DERIVED_EPIK:
                                d.St.derivedEpikDataSource = tn(u, a);
                                break;
                            case y.UNAUTH:
                                d.St.unauthIdDataSource = tn(u, a)
                        }
                    }
            }(s.getCookies()), d._t(v));
        e && I() && ("1" === f.getParameterFromURI(m.NATIVE_CHECKOUT) && e.setItem(m.NATIVE_CHECKOUT, d.At()), t = parseInt(f.getParameterFromURI(m.IAB_IOS)), null != (n = t) && Number(n) == n && (new Date).getTime() - n <= 3e5 && e.setItem(m.IAB_IOS, t), document.referrer) && document.referrer.startsWith("android-app") && document.referrer.includes("com.pinterest") && e.setItem(m.IAB_ANDROID, d.At())
    }, d.setconsent = function(t) {
        t = l(t, 1)[0];
        d.bt = f.toBooleanType(t), !1 === d.bt && Wt()
    }, d.set = function(t) {
        un(l(t, 1)[0])
    }, d.page = function(t) {
        var t = l(t, 1)[0],
        ...
        e ? (n.tid = e, t && ("object" === O(t) ? (rn(t), n.ov = t) : console.warn(q + "Unexpected value passed to page command. Please consult the Pinterest Tag Guide for correct notation.")), Vt(n), window.pintrk.partnerData && (n.pd = window.pintrk.partnerData), n[Q] = "init", d.Nt(n)) : console.info(c + "'page' command was called without first calling the 'load' command.  Forthcoming Pinterest tag events may fail.")
    }, d.track = function(t) {
        var n, t = l(t, 5),
            e = t[0],
            r = t[1],
        ...
        if (d.vt.isEnabled() && d.vt.isNoCodeCAPIIntegrated()) {
            var a = r = r || {};
            try {
                d.vt.isEnabled() && (ct.some(function(t) {
                    return a[t]
                }) || (a.event_id = "PIN-" + $()), zt = !1)
            } catch (t) {
                d.ct.error("NoCodeCAPI error generating eventid", t), zt = !0
            }
        }
        return e && "string" == typeof e ? (e = e.trim(), -1 === vt.indexOf(e.toLowerCase()) && console.warn(q + "'%s' is not a standard event name. You may use it to build audiences, but conversion reporting will not be available. Standard event names are: [%s]", e, vt.toString()), u[Q] = e) : j("eventName", e, "string"), r && "object" === O(r) ? (void 0 === r.value || isNaN(r.value) || (r.value = Number(r.value)), j("value", r.value, "number"), e = "order_quantity", null == (n = r.order_quantity) || Number(n) == n && n % 1 == 0 || console.info(c + "Expected '%s' to be an integer, but found '%s'", e, n), void 0 !== r.external_id && (K({
            external_id: f.hashParam(r.external_id)
        }), delete r.external_id), e = function(t) {
            for (var n = {}, e = 0, r = Object.entries(t); e < r.length; e++) {
                var i = l(r[e], 2),
                    o = i[0],
                    i = i[1];
                n[o] = "string" == typeof i && /[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+(?:[A-Za-z]{2}|com|org|net|gov|mil|biz|info|mobi|name|aero|jobs|museum)\b/.test(i) ? f.hashParam(i) : i
            }
            return n
        }(r), u.ed = e) : j("eventData", r, "object"), "function" != typeof i && (j("callback", i, "function"), i = null), (o = (o = Jt(o)) || window.pintrk.tagId) ? (u.tid = String(o).trim(), t && "object" === O(t) && (rn(t), u.ov = t), Vt(u), n = window.location.pathname, Nt.test(n) || window.pintrk.partnerData && "shopify" === window.pintrk.partnerData.np && Rt.test(n) ? T(u, [x, d.Tt(u, i)], d.yt.EVENT_SHOPIFY_SCRAPE) : d.St.tagConfigsReceived ? (d.St.tagConfigsAtLeastOneEnabled && ln(), window.pintrk.partnerData && (u.pd = window.pintrk.partnerData), !d.ht.isInRampPercentage(d.ht.LIST.DERIVED_EPIK.chance) || s.readCookie(y.DERIVED_EPIK) || Qt(w.DERIVED_EPIK) || T(u, [x], d.yt.TAGS_RECEIVED, !0), d.Nt(u, i)) : T(u, [x, d.xt(u, i)], d.yt.EVENT_TAGS_ABSENT)) : (console.info(c + "'load' command was not called before 'track'.  Did you install the base code?"), i && i(!1, "The Pinterest Tag ID is missing.")), 0
    }, d.xt = function(t, n) {
        return function() {
            try {
                return hn(tagConfig = JSON.parse(this.responseText)), d.St.tagConfigsAtLeastOneEnabled && ln(), window.pintrk.partnerData && (t.pd = window.pintrk.partnerData), d.Nt(t, n), 0
            } catch (t) {
            ...
            try {
                ...
                return (tagConfig = JSON.parse(this.responseText)) && (d.St.tagConfigsAtLeastOneEnabled = function(t) {
                    ...
                    try {
                        for (e.s(); !(n = e.n()).done;) {
                            var r = n.value;
                            if (f.toBooleanType(t[r.tagConfigKey])) return !0
                        }
                    } catch (t) {
                        e.e(t)
                    } finally {
                    ...
                    return !1
                }(tagConfig)), d.St.tagConfigsAtLeastOneEnabled && (t = tagConfig, n = document.getElementsByTagName("bdo"), e = window.pintrk.partnerData && window.pintrk.partnerData.aem_eligible_list ? window.pintrk.partnerData.aem_eligible_list : [], n && n[0] && (n = n[0].textContent) && "string" == typeof n && Ot.test(n.trim().toLowerCase()) && D(t, n, b, E, e), (n = document.getElementsByTagName("address")) && n[0] && (n = n[0].innerHTML) && "string" == typeof n && (n = n.split("<br>")) && (n[0] && jt.test(n[0].trim().toLowerCase()) && ((r = n[0].split(" ")) && 1 === r.length ? D(t, r[0], g, Lt, e) : r && 2 === r.length && (D(t, r[0], g, Pt, e), D(t, r[1], g, Lt, e))), 3 <= n.length && n[2] && (r = n[2].split(" ")) && (r[0] && p.test(r[0].trim().toLowerCase()) && D(t, r[0], _, Mt, e), r[1] && p.test(r[1].trim().toLowerCase()) && D(t, r[1], _, Ut, e), r[2]) && It.test(r[2].trim().toLowerCase()) && D(t, r[2], _, Bt, e), 4 <= n.length && n[3] && p.test(n[3].trim().toLowerCase()) && D(t, n[3], _, Gt, e), 5 <= n.length) && n[4] && Ct.test(n[4].trim().toLowerCase()) && D(t, n[4], Tt, Dt, e), K({
                    aem_eligible_list: e
            ...
            return A().wrap(function(t) {
                for (;;) switch (t.prev = t.next) {
                    case 0:
                        ...
                        }, e.tid = window.pintrk.tagId, t.next = 9, fetch(Y, {
                            method: "POST",
                            headers: {
        ...
        if (d.bt) return h = d.kt(), d.Rt().catch(function(t) {
            ...
            var n = h,
                ...
                n = (n.ecm_enabled = t, s.ad = n, s[X] = d.At(), window.pintrk.piaa && 6 < window.pintrk.piaa.length && (s.piaa = window.pintrk.piaa), d.Ot(s));
            (N() ? R : Yt)();
            var e = {
                eventSourceEligible: !1,
                triggerEligible: !0
            };
            if (d.lt(Z, n).length < 2048) {
                new URLSearchParams;
                var r = d.Ot(s),
                    r = d.lt(Z, r);
                try {
                ...
                for (var i = new URLSearchParams, r = d.Ot(s), o = 0, u = Object.entries(r); o < u.length; o++) {
                    var a = l(u[o], 2),
                        f = a[0],
                        a = a[1];
                    i.append(f, a)
            ...
            r = s;
            try {
                d.vt.isEnabled() && !zt && d.vt.sendNoCodeCAPIEvent(r, function() {})
            } catch (t) {
                d.ct.error("NoCodeCAPI call error", t)
            }
            t = d._t(v);
            t && I() && n[Q] === dt && t.removeItem(m.NATIVE_CHECKOUT)
        });
        c && c(!1, "No consent")
    }, d.At = function() {
        ...
        if (window.pintrk.mh) {
            ...
            if (d.ht.isInRampPercentage(d.ht.LIST.CHECK_AUTO_UPGRADED.chance)) try {
                ...
                e ? (r = f.getHashFromURI(e.src)) && r !== window.pintrk.mh && (window.pintrk.cs = r, n.cs = r) : window.pintrk.cs && (n.cs = window.pintrk.cs)
            } catch (t) {
                d.ct.error("Add script source to automaticData", t)
            }
        }
        var e = d._t(v),
            r = (e && I() && (e.getItem(m.NATIVE_CHECKOUT) && (t[m.NATIVE_CHECKOUT] = e.getItem(m.NATIVE_CHECKOUT)), e.getItem(m.IAB_IOS) && (t[m.IAB_IOS] = e.getItem(m.IAB_IOS)), e.getItem(m.IAB_ANDROID)) && (t[m.IAB_ANDROID] = e.getItem(m.IAB_ANDROID)), N());
        return null != r && (t[u] = r), k() && (t.epikDataSource = d.St.epikDataSource, t.derivedEpikDataSource = d.St.derivedEpikDataSource, t.unauthIdDataSource = d.St.unauthIdDataSource), t
    }, d.Kt = function(t, n) {
        function e() {
    ...
    ! function(n) {
        ...
        t(i, e), i.prototype.init = function() {
            ...
            for (var f, s, c, h = 0; h < 80; ++h) var l = ~~(h / 20),
                d = 0 | (e << 5 | e >>> 27) + (f = r, s = i, c = o, 0 === (d = l) ? f & s | ~f & c : 2 === d ? f & s | f & c | s & c : f ^ s ^ c) + u + n[h] + v[l],
                u = o,
                o = i,
                i = r << 30 | r >>> 2,
                r = e,
    ...
    n.byteLength = function(t) {
        ...
        var n, e, r = c(t),
            ...
            u = 0,
            a = 0 < r ? i - 4 : i;
        for (e = 0; e < a; e += 4) n = f[t.charCodeAt(e)] << 18 | f[t.charCodeAt(e + 1)] << 12 | f[t.charCodeAt(e + 2)] << 6 | f[t.charCodeAt(e + 3)], o[u++] = n >> 16 & 255, o[u++] = n >> 8 & 255, o[u++] = 255 & n;
        2 === r && (n = f[t.charCodeAt(e)] << 2 | f[t.charCodeAt(e + 1)] >> 4, o[u++] = 255 & n);
        1 === r && (n = f[t.charCodeAt(e)] << 10 | f[t.charCodeAt(e + 1)] << 4 | f[t.charCodeAt(e + 2)] >> 2, o[u++] = n >> 8 & 255, o[u++] = 255 & n);
        return o
    ...
    for (var a = [], f = [], s = "undefined" != typeof Uint8Array ? Uint8Array : Array, r = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", i = 0, o = r.length; i < o; ++i) a[i] = r[i], f[r.charCodeAt(i)] = i;
    ...
    n.read = function(t, n, e, r, i) {
        ...
        var u, a, f = 8 * o - i - 1,
            ...
            d = r ? 1 : -1,
            o = n < 0 || 0 === n && 1 / n < 0 ? 1 : 0;
        for (n = Math.abs(n), isNaN(n) || n === 1 / 0 ? (a = isNaN(n) ? 1 : 0, u = s) : (u = Math.floor(Math.log(n) / Math.LN2), n * (r = Math.pow(2, -u)) < 1 && (u--, r *= 2), 2 <= (n += 1 <= u + c ? h / r : h * Math.pow(2, 1 - c)) * r && (u++, r /= 2), s <= u + c ? (a = 0, u = s) : 1 <= u + c ? (a = (n * r - 1) * Math.pow(2, i), u += c) : (a = n * Math.pow(2, c - 1) * Math.pow(2, i), u = 0)); 8 <= i; t[e + l] = 255 & a, l += d, a /= 256, i -= 8);
        for (u = u << i | a, f += i; 0 < f; t[e + l] = 255 & u, l += d, u /= 256, f -= 8);
        t[e + l - d] |= 128 * o
    }
}, function(t, n) {
    var e = {}.toString;
    ...
    ! function(n) {
        ...
        t(i, e), i.prototype.init = function() {
            ...
            for (var n, e = this.K, r = 0 | this.P, i = 0 | this.L, o = 0 | this.D, u = 0 | this.M, a = 0 | this.U, f = 0; f < 16; ++f) e[f] = t.readInt32BE(4 * f);
            for (; f < 80; ++f) e[f] = (n = e[f - 3] ^ e[f - 8] ^ e[f - 14] ^ e[f - 16]) << 1 | n >>> 31;
            for (var s, c, h, l = 0; l < 80; ++l) var d = ~~(l / 20),
                v = 0 | (r << 5 | r >>> 27) + (s = i, c = o, h = u, 0 === (v = d) ? s & c | ~s & h : 2 === v ? s & c | s & h | c & h : s ^ c ^ h) + a + e[l] + y[d],
                a = u,
                u = o,
                o = i << 30 | i >>> 2,
                i = r,
    ...
    c.St = {
        ...
        c.isEnabled() && (c.St.cookieOptIn = n, t && t[a] ? (this.setEndpoint(t[a]), c.St.partner_name = "ss-nocodecapi".concat("-").concat(t.partner_name || "aws")) : u.deleteCookie(u.FP_COOKIES.NCCAPI_URL))
                ...
                if (this.Bt(o))
                    if (this.Ft(o)) n.push('<meta itemscope="" itemtype="' + o + '" content="ph">');
                        ...
                        for (var f = 0; f < u.length; f++) {
                            for (var s = u[f]; 0 < a.length && !a[a.length - 1].element.contains(s);) this.zt(a);
                            s.hasAttribute("itemscope") ? (e.add(s), a.push({
                                element: s,
                                htmlContent: ""
                            })) : a[a.length - 1].htmlContent += s.outerHTML
                        }
    ...
    t.exports = function(t, n, e) {
        var r = n && e || 0,
            ...
            f = u - v + (a - y) / 1e4;
        if (f < 0 && void 0 === t.clockseq && (e = e + 1 & 16383), 1e4 <= (a = (f < 0 || v < u) && void 0 === t.nsecs ? 0 : a)) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        v = u, h = e, f = (1e4 * (268435455 & (u += 122192928e5)) + (y = a)) % 4294967296, i[r++] = f >>> 24 & 255, i[r++] = f >>> 16 & 255, i[r++] = f >>> 8 & 255, i[r++] = 255 & f, t = u / 4294967296 * 1e4 & 268435455, i[r++] = t >>> 8 & 255, i[r++] = 255 & t, i[r++] = t >>> 24 & 15 | 16, i[r++] = t >>> 16 & 255, i[r++] = e >>> 8 | 128, i[r++] = 255 & e;
        for (var s = 0; s < 6; ++s) i[r + s] = o[s];
        return n || d(i)
    }
}, function(t, n, e) {
    var u = e(9),
