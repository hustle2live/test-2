! function() {
    ...
    function r(e, t) {
        n(t),
            function t(e, i) {
                let o = w(e, i, u.triggerElements);
                let n = w(e, i, u.cssSelectors);
                p[i] = p[i] || [];
                f[i] = f[i] || [];
                v[i] = v[i] || [];
    ...
    function w(t, n, i) {
        ...
        for (let e = 0; e < a.length; e++) {
            ...
            if (function(e, t) {
                    ...
                    root: t,
                    scopeName: n + "/iframe"
                }, d.removeEventListener("load", h), d.addEventListener("load", h), d.contentDocument))
...
function _TTDUniversalPixelApi(G) {
    var K = "1.1.0";
    const s = ["ru6qq3d", "ufqc9us", "ugj89je", "foh1kju", "1znfrjo", "xjagv7s", "0g3yesi", "6kn3s7q", "d5bjpnk", "k8v60jg", "t6jmgnz", "e2zo2dn", "Yb4bc7v", "80qouob", "fndgd00", "7b1me90", "rz1ru9d"];

    function J(e) {
        return new URL(e).hostname
    }
    async function c(r, d, s, e, t, c) {
        this._uid2SdkListenerLock = {}, this.setupUid2Sdk = function(e, i, o) {
            void 0 === this._uid2SdkListenerLock[e] && (this._uid2SdkListenerLock[e] = 1, void 0 === window.__uid2 && void 0 === window.ttdPixel.uid2SdkLoaderPromise ? window.ttdPixel.uid2SdkLoaderPromise = new Promise((e, t) => {
                ...
                n.setAttribute("defer", !0), n.setAttribute("src", "https://js.adsrvr.org/uid2-sdk.js"), n.addEventListener("load", () => {
                    e(), i()
        ...
        if (l) {
            ...
            if ("undefined" != typeof _pixelParams)
                for (var m in _pixelParams) {
                    var g = _pixelParams[m],
                        m = f[m];
                    m && g && !/%%.*%%/i.test(g) && (g = encodeURIComponent(g), v.push(m + "=" + g), p[m] = g)
                }
            var y = "adv=" + r,
                h = "upid=" + d.join(","),
                w = (p.adv = r, G || function() {
                    var e = window,
                        t = "",
                        n = !1;
                    try {
                ...
                _ = encodeURIComponent(w),
                w = (p.ref = w, K);
            if (p.upv = w, u = s + "?" + y + "&ref=" + _ + "&" + h + "&upv=" + w, e)
                for (var b in e) u = u + "&" + b + "=" + e[b], p[b] = e[b];
            0 < v.length && (u = u + "&" + v.join("&")), navigator.joinAdInterestGroup && (u += "&paapi=1", p.paapi = "1"), localStorage.getItem("UID2-sdk-identity") && (u += "&uidcs=1", p.uidcs = "1");
            let n;
            ...
            var E = null,
                D = !1,
                T = null;
            "function" == typeof __tcfapi ? (k = setTimeout(z, 1e3), __tcfapi("addEventListener", 2, B)) : "function" == typeof __cmp ? (E = setTimeout($, 1e3), __cmp("ping", null, U)) : "function" == typeof __gpp ? void 0 !== (y = I()).gppString ? N(y.gppString, y.gppSid) : (L = setTimeout(F, 1e3), __gpp("addEventListener", M)) : R();
            let i = !1;
            void 0 !== t && (i = !0);
            let o = r + ":" + d.join(","),
                a = !1;
            i ? (a = !0, this.setupUid2Sdk(o, () => j(t), e => {
                ...
                try {
                    if (null !== e.origin && "null" !== e.origin) {
                        ...
                        if (t.hostname.endsWith(".adsrvr.org") && !i && "string" == typeof e.data) {
                            ...
                            n.type && "string" == typeof n.type && "UID2" === n.type && n.advertiserId && "string" == typeof n.advertiserId && n.advertiserId == r && (a = !0, this.setupUid2Sdk(o, () => j(n), e => {
                                console.warn("UID2 enabled but failed to register hooks: ", e)
                            }))
                        }
                    }
            ...
            var L = null,
                ...
                x = !1;
            async function P() {
                "hidden" === document.visibilityState && (c && await W(p), document.removeEventListener("visibilitychange", P))
            }
            async function H(e, n) {
                try {
                    ...
                    }(n) && (void 0 !== n.email ? window.__uid2.setIdentityFromEmail(n.email, n) : void 0 !== n.emailHash ? window.__uid2.setIdentityFromEmailHash(n.emailHash, n) : void 0 !== n.phone && window.__uid2.setIdentityFromPhone(n.phone, n)), o ? (c ? await W(p, o.advertising_token) : await O(o.advertising_token), document.removeEventListener("visibilitychange", P)) : window.ttdPixel.activeDetection || (t = new Promise(t => {
                    ...
                    }), i = await (window.ttdPixel.activeDetection = t), await window.__uid2.setIdentityFromEmail(i, n))
                } catch (e) {
                ...
                try {
                    window.__uid2.callbacks.push(async (e, t) => {
                        switch (e) {
                            case "SdkLoaded":
                                try {
                                    window.__ttd_m_invoke_once = window.__ttd_m_invoke_once || {}, window.__ttd_m_invoke_once._uid2_init || (window.__ttd_m_invoke_once._uid2_init = 1, n.baseUrl || (n.baseUrl = "https://global.prod.uidapi.com"), __uid2.init({
                                        baseUrl: n.baseUrl
                                    }))
                                } catch (e) {
                                ...
                                break;
                            case "InitCompleted":
                                await H(() => t.identity, n);
                                break;
                            case "IdentityUpdated":
                                c ? await W(p, t.identity.advertising_token) : await O(t.identity.advertising_token), document.removeEventListener("visibilitychange", P)
                        }
                    })
                } catch (e) {
            ...
            function M(e, t) {
                var n;
                S ? __gpp("removeEventListener", function() {}, e.listenerId) : "signalStatus" === e.eventName && "ready" === e.data && (n = I(), clearTimeout(L), T = new Date, N(n.gppString, n.gppSid), __gpp("removeEventListener", function() {}, e.listenerId))
            }
            ...
            function U(e) {
                D || (e.cmpLoaded || e.gdprAppliesGlobally ? (clearTimeout(E), T = new Date, __cmp("getConsentData", null, R)) : setTimeout(function() {
                    __cmp("ping", null, U)
                }, 200))
            }
            ...
            function R(e) {
                var t;
                null != T && (t = new Date - T, u = u + "&ret=" + t, p.ret = t), D && (u += "&pto=1", p.pto = "1"), null != e && (t = e.gdprApplies ? "1" : "0", u = u + "&gdpr=" + t + "&gdpr_consent=" + e.consentData, p.gdpr = t, p.gdpr_consent = e.consentData), A()
            }
            async function A() {
                var e = "universal_pixel_" + d.join("_");
                n(u), await C(u, e, "TTD Universal Pixel"), document.addEventListener("visibilitychange", P)
            }
            async function O(e, t) {
                await C(await q + "&uiddt=" + e + "&uidcs=" + t, "universal_pixel_" + d.join("_") + "_uid", "TTD Universal Pixel with UID")
            }
            async function C(e, t, n) {
                ...
                function r() {
                    l.appendChild(o), setTimeout(async () => {
                        c && !a && (await W(p), document.removeEventListener("visibilitychange", P))
                    }, 1e3)
                }
            ...
            function B(e, t) {
                var n;
                x ? __tcfapi("removeEventListener", 2, function(e) {}, e.listenerId) : t && (clearTimeout(k), t = e, null != T && (n = new Date - T, u = u + "&ret=" + n, p.ret = n), x && (u += "&pto=1", p.pto = "1"), null != t && (n = function(e) {
                    return e ? "1" : "0"
                }(t.gdprApplies), u = u + "&gdpr=" + n + "&gdpr_consent=" + t.tcString, p.gdpr = n, p.gdpr_consent = t.tcString), A(), T = new Date, __tcfapi("removeEventListener", 2, function(e) {}, e.listenerId))
            }

            function N(e, t) {
                var n;
                null != T && (n = new Date - T, u = u + "&ret=" + n, p.ret = n), null != e && (u = u + "&gpp_consent=" + e, p.gpp_consent = e), null != t && (u = u + "&gpp_sid=" + t, p.gpp_sid = t), A()
            }
            async function W(i, e) {
                i.pixel_ids = d, e && (i.uid2_token = e);
                const o = {
                        data: [{ ...i
                        }]
                    },
                    r = `https://${J(s)}/track/realtimeconversion`;
                return new Promise((e, t) => {
                    const n = new XMLHttpRequest;
                    n.withCredentials = !0, n.open("POST", r), n.setRequestHeader("Content-type", "application/json"), n.setRequestHeader("eventDataSource", "UpSdk"), n.setRequestHeader("eventDataSourceVersion", K), n.onload = () => {
                        (200 <= n.status && n.status < 300 ? e : t)(n.response)
                    }, n.onerror = async () => {
                        t(n.statusText), async function(e) {
                            var t = "universal_pixel_" + d.join("_");
                            e.eds = "UpSdkGet", e.edsv = K, e.upid = d.join(",");
                            const {
                                pixel_ids: n,
                                ...i
                            } = e;
                            e = new URLSearchParams(i), await C(`https://${J(s)}/track/rt` + "?" + e.toString(), t, "TTD Universal Pixel Realtime")
                        }(i)
    ...
    this.init = async function(t, n, i, o, r, a) {
        ...
        if (t && "" != t && n && !(n.length <= 0)) {
            let e = i;
            var d;
            (a = s.includes(t) ? !0 : a) && (d = J(i), e = `https://${d}/track/cei`), await c(t, n, e, o, r, a)
        }
    }
}
