                ...
                device === 'desktop' &&
                    ...
                    /p> {
                        amountDiscount ? < span className = "dib white b f12 flux-promo-pct-discount" > -{
                            ...
                            < span className = {
                                `f12 dib pt1 ${stylePayment}`
                            } > Paiement standard < /span>
                    } <
                    /div> <
                    div className = {
                    ...
                    span className = "dib f35" > {
                        ...
                        <
                        span className = "dib f35" > {
                            Math.trunc(paiement4X(data.price))
                        } < sup className = "f14 price-euro-club" > € < /sup></span > {
                            getFraction(paiement4X(data.price)) !== ',00' ? < span className = "f14 dib nl3" > {
                                getFraction(paiement4X(data.price))
                            } < /span> : '' } <
                            /div> <
                            div className = "dib" > < span className = "dib" > avec le paiement < /span><img className="relative pl2 icon4xCB" src="https:/ / images.fr.shopping.rakuten.com / visuels / 0 _merch / OP / Logos / 4 xcb.svg " alt="
                            paiement 4 XCB " /><sup>*</sup></div> <
                            /div> <
                            /div>
                        } {
                            device === 'mob-tab' &&
                                <
                                div className = "flux-promo-blocPrice-4X_small-device center flex flex-column mt1" >
                                <
                                ...
                                /p> {
                                    amountDiscount ? < span className = "dib white b f10 flux-promo-pct-discount" > -{
                                        ...
                                        < span className = {
                                            `f10 dib pt1 ${stylePayment}`
                                        } > Paiement standard < /span>
                                } <
                                /div> <
                                div className = {
                                    `flux-promo-blocPrice-4X_price OpenSans-eb fw8 pt1 ${stylePrice}`
                                } >
                                <
                                span className = "dib f20" > {
                                    ...
                                    span className = "dib f20" > {
                                        ...
                                        getFraction(paiement4X(data.price)) !== ',00' ? < span className = "f10 dib price-decimal" > {
                                            getFraction(paiement4X(data.price))
                                        } < /span> : '' } <
                                        /div> <
                                        div className = "dib" > < span className = "dib" > avec le paiement < /span><img className="relative pl2 icon4xCB" src="https:/ / images.fr.shopping.rakuten.com / visuels / 0 _merch / OP / Logos / 4 xcb.svg " alt="
