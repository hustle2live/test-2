...
function BlocClub(props) {
    ...
    return ( <
        React.Fragment > {
            ...
            <
            img className = "dib"
            src = "https://images.fr.shopping.rakuten.com/visuels/Club-Rakuten/page/LogoCRdesk.svg"
            alt = "Club R" / >
            <
            p className = "f12 red-rkt b db dib-l pl1" > {
                formatedPrice(RSP)
            }€
            offerts < span className = "normal main-black" > sur vos prochains achats < /span></p >
            <
            /div>
        } {
            device === 'mob-tab' && !isNewBook &&
                ...
                <
                img src = "https://images.fr.shopping.rakuten.com/visuels/Club-Rakuten/page/LogoCRdesk.svg"
            alt = "Club R" / >
                <
