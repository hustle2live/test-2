! function(e) {
    function r(r) {
        for (var n, l, f = r[0], p = r[1], i = r[2], c = 0, s = []; c < f.length; c++) l = f[c], Object.prototype.hasOwnProperty.call(o, l) && o[l] && s.push(o[l][0]), o[l] = 0;
    ...
    var f = this["webpackJsonpflux-promo"] = this["webpackJsonpflux-promo"] || [],
        p = f.push.bind(f);
    f.push = r, f = f.slice();
