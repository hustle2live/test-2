...
(function() {
    ...
    var Utils = function() {
        ...
        c.object2Flatten = function(a, b, f, e, d) {
            ...
            for (u in a)
                if (a.hasOwnProperty(u))
                    if (n = c.splitProtocolAndKey(u, d), p = n.prefix || e || "", m = (b ? b + "_" : "") + n.key, c.isObject(a[u])) c.object2Flatten(a[u], m, f, p, d);
                    else {
                        r = m.split("_");
                        h = "";
        ...
        c.completeFstLevelObj = function(a,
            ...
            if (a) {
                if (b)
                    for (var e in b) !b.hasOwnProperty(e) || a[e] && !f || (a[e] = b[e])
            } else a = b;
            return a
        };
        ...
        c.arrayIndexOf =
            function(a, b) {
                ...
                return function(a) {
                    ...
                    if (g >= f) return -1;
                    for (g = 0 <= g ? g : Math.max(f - Math.abs(g), 0); g < f; g++)
                        if (g in b && b[g] === a) return g;
                    return -1
                }.apply(a, [b])
            };
        c.uuid = function() {
        ...
        c.isPrerender = function(a) {
            ...
            if ("prerender" === document.visibilityState) b = "visibilitychange";
                ...
                for (var d = 0; d < e.length; d++) "prerender" === document[e[d] + "VisibilityState"] && (b = e[d] + "visibilitychange");
        ...
        c.hashcode = function(a) {
            ...
            for (var f = 0; f < a.length; f++) var e = a.charCodeAt(f),
                b = (b << 5) - b + e,
                b = b | 0;
            return b
        };
        ...
        c.privacy = new function() {
            ...
            function f(a, b, d, e, g) {
                ...
                if (!a || "object" !== typeof a || a instanceof Array)
                    if ("undefined" !== typeof a && 0 <= d.indexOf(g) || "undefined" === typeof d) m[g] = a;
                    else
                        for (b = 0; b < d.length; b++) {
                            ...
                            for (var c in a) a.hasOwnProperty(c) && f(a[c], b, d, m, (g ? g + b : "") + c);
            ...
            function h(a) {
                for (var b = [], e = {}, f = 0; f < a.length; f++)
                    if ("string" === typeof a[f]) {
                        ...
                        for (var c in a[f]) a[f].hasOwnProperty(c) && (0 > b.indexOf(c) && b.push(c), 0 > a.indexOf(c) && (e[c] = (e[c] || []).concat(a[f][c])));
                return {
                    keys: b,
                    values: e
                }
            ...
            p.testStorageParam = function(a, b) {
                ...
                if (m.storageParams instanceof Array) {
                    for (var d, f = m.storageParams.length - 1; 0 <= f; f--)
                        if (d = m.storageParams[f], "string" === typeof d) {
                            if (d === a || d === p.ALL) return {
                                toSetInStorage: !0
                            }
                        } else {
                            a: {
            ...
            p.processStorageParams = function(a, b, e) {
                if (e) {
                    ...
                    if (d.keys[0] !== p.ALL)
                        for (var f in e)
                            if (e.hasOwnProperty(f) && void 0 !== e[f])
                                if (-1 === c.arrayIndexOf(d.keys, f)) a && a(f);
                                else if (c.isObject(e[f])) {
                        var g = f,
                            l = e[f].val,
                            r = d.values[f],
                            q = a,
            ...
            p.testBufferParam = function(b, d) {
                var f, l;
                if (m.bufferParams instanceof Array) {
                    f = h(m.bufferParams);
                    for (l = 0; l < f.keys.length; l++)
                        if (f.keys[l] === b || f.keys[l] === p.ALL)
                            if (f.values.hasOwnProperty(f.keys[l])) {
                                var r = {};
                                ...
                                a: {
                                    ...
                                    if (c.isObject(r)) {
                                        var w = void 0,
                                            ...
                                            D = w = w = void 0;
                                        for (D in r)
                                            if (r.hasOwnProperty(D) && f === D && (w = l, "string" === typeof w && (w = c.jsonParse(w) || w), "object" === typeof w)) {
                    ...
                    if (l.keys[0] !== p.ALL)
                        for (var r in f)
                            if (f.hasOwnProperty(r))
                                if (-1 === c.arrayIndexOf(l.keys, r)) b && b(r);
                                else {
                                    var w = r,
                                        q = f[r],
                                        k = l.values[r],
        ...
        c.isOptedOut = function() {
            if (null === c.optedOut) {
                var a;
                a: {
                    a = null;c.isLocalStorageAvailable() && (a = localStorage.getItem("atuserid"));
                    if (null === a) {
    ...
    var BuildManager = function(a) {
            var k = this,
                ...
                f = function(f, e, d) {
                        ...
                        s = function(e) {
                            ...
                            for (B in e)
                                if (e.hasOwnProperty(B))
                                    if (u = p = k = q = !1, s = e[B]._value, n = e[B]._options || {}, "boolean" === typeof n.encode && (q = n.encode), "function" === typeof s &&
                                        (s = s()), s = s instanceof Array ? s.join(n.separator || ",") : "object" === typeof s ? ATInternet.Utils.jsonSerialize(s) : "undefined" === typeof s ? "undefined" : s.toString(), q && (s = encodeURIComponent(s)), -1 < ATInternet.Utils.arrayIndexOf(b, B) ? k = !0 : "boolean" === typeof n.truncate && (k = n.truncate), "boolean" === typeof n.multihit && (p = n.multihit), "boolean" === typeof n.last && (u = n.last), s = g(B, s, k, p, n.separator, q, u), p) c -= s.paramSize + s.strSize, G += s.param + s.str;
                                    else if (u) s.paramSize + s.strSize > c && (s.str = s.str.substring(0, c - s.paramSize),
                                s.strSize = s.str.length), v = B, A = s;
                            else if (d[B] = s, d[B].paramSize + d[B].strSize > c && !d[B].truncate) {
                            ...
                            if (null === e[1]) f = e[0];
                                ...
                                for (f.push(e[0]); null !== e[1];) e = l(e[1], c), f.push(e[0]);
                            return f
                        },
                        n = "";
                    ...
                    if (ATInternet.Utils.isObject(f)) {
                        ...
                        for (q in e = a.buffer.get(e, !0), n = s(e), e) e.hasOwnProperty(q) && (e[q]._options && e[q]._options.permanent || a.buffer.del(q));
                    d && d(n, h)
                };
                    ...
                    e(function(e, g) {
                        e ? d && d(e) : (c = h - (g.length + 27), f(a, b, function(a, b) {
                            ...
                            if (a instanceof Array)
                                for (var c = 1; c <= a.length; c++) e.push(g + b + "&mh=" + c + "-" + a.length + "-" + f + a[c - 1]);
                            else e.push(g + b + a);
                            d && d(null, e)
                        }))
                    })
            ...
            k.send = function(b, e, f, d, g) {
                q(b, e, function(b, e) {
                    if (b) a.emit("Tracker:Hit:Build:Error", {
                        ...
                        for (var c = 0; c < e.length; c++) k.sendUrl(e[c], f, d, g)
                })
            };
        ...
        PluginsManager = function(a) {
            var k = {},
                ...
                l = this.unload = function(b) {
                    g(b) ? (k[b] = void 0, a.emit("Tracker:Plugin:Unload:" + b + ":Ok", {
                        lvl: "INFO"
            ...
            this.waitForDependencies = function(b, e) {
                ...
                if (0 === f.mcount) a.emit("Tracker:Plugin:Dependencies:Loaded", {
                    ...
                    for (var d in f.plugins) f.plugins.hasOwnProperty(d) && (a.emit("Tracker:Plugin:Dependencies:Error", {
                        lvl: "WARNING",
            ...
            var k = this,
                ...
                c = function(b) {
                    if (b.name) {
                        ...
                        ATInternet.Callbacks && ATInternet.Callbacks.hasOwnProperty(b.name) && (g = {}, g[b.name] = {
                            "function": ATInternet.Callbacks[b.name]
                        }, d && k.load(b.name, g[b.name]["function"]), ATInternet.Tracker.callbackProtos[b.name] || (ATInternet.Tracker.callbackProtos[b.name] = g[b.name]))
                    }
                };
            k.load = function(b, d) {
            ...
            k.init = function() {
                if (a.getConfig("activateCallbacks")) {
                    ...
                    if ("undefined" !== typeof b && b.include instanceof Array)
                        for (var d = 0; d < b.include.length; d++) ATInternet.Callbacks && ATInternet.Callbacks.hasOwnProperty(b.include[d]) && (h[b.include[d]] = {
                                "function": ATInternet.Callbacks[b.include[d]]
                            }, ATInternet.Tracker.callbackProtos[b.include[d]] ||
                            (ATInternet.Tracker.callbackProtos[b.include[d]] = h[b.include[d]]));
                    else
                        for (d in ATInternet.Callbacks) ATInternet.Callbacks.hasOwnProperty(d) && (h[d] = {
                            "function": ATInternet.Callbacks[d]
                        }, ATInternet.Tracker.callbackProtos[d] || (ATInternet.Tracker.callbackProtos[d] = h[d]));
                    if ("undefined" !== typeof b && b.exclude instanceof Array)
                        for (d = 0; d < b.exclude.length; d++) delete h[b.exclude[d]];
        ...
        BufferManager = function(a) {
            ...
            k.set = function(a, b, c) {
                ...
                b.toSetInBuffer && (c = c || {}, c.hitType = c.hitType || ["page"], h[a] = {
                    _value: b.value,
                    _options: c
                })
            };
            var c = function(a, b, c) {
                ...
                b = function g(a, b) {
                    ...
                    k.shift();
                    for (var m = 0; m < b.length; m++)
                        if ("object" !== typeof e[1]) h[b[m]] && h[b[m]]._options[e[0]] === e[1] && n.push(b[m]);
                        else {
                            c = e[1].length;
                            for (var r = 0; r < c; r++)
                                if (h[b[m]] && h[b[m]]._options[e[0]] instanceof Array && 0 <= ATInternet.Utils.arrayIndexOf(h[b[m]]._options[e[0]], e[1][r])) {
                                    n.push(b[m]);
                                    break
                                }
                        }
            ...
            k.get = function(a, l) {
                var f = {};
                if ("string" === typeof a) f = c(h, a, l);
                else
                    for (var e = b(a, ATInternet.Utils.getObjectKeys(h)), q = 0; q < e.length; q++) f[e[q]] = c(h, e[q], l);
                return f
            };
            ...
            k.addInFilters = function(a, b, f, e) {
                ...
                return [
                    [c, h]
                ].concat(k.addInFilters(a.slice(1), b, f, e))
            };
            k.del = function(a) {
                h[a] = void 0
            };
        ...
        PropertiesManager = function(a) {
            ...
            k.setProps = function(a, b) {
                if (ATInternet.Utils.isObject(a))
                    for (var d in a) a.hasOwnProperty(d) && k.setProp(d, a[d], b)
            };
        ...
        Tag = function(a, k, h) {
            ...
            c.delContext = function(a, e) {
                c.emit("Tracker:Context:Deleted:" + a + ":" + e, {
                    lvl: "INFO",
                    details: {
                        key1: a,
                        key2: e
                ...
                if (a) b.hasOwnProperty(a) && (e ? b[a] && b[a].hasOwnProperty(e) && (b[a][e] = void 0) : b[a] = void 0);
                else if (e)
                    for (var d in b) b.hasOwnProperty(d) && b[d] && b[d].hasOwnProperty(e) && (b[d][e] = void 0)
            };
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Campaigns = function(a) {
        function k(a, b, e) {
            for (var d = {}, f = RegExp("[&#?]{1}([^&=#?]*)=([^&#]*)?", "g"), c = f.exec(b); null !== c;) 0 === c[1].indexOf(a) && (d[e + c[1].substring(a.length)] = c[2]), c = f.exec(b);
            return d
        }
        ...
        var d, g, l, f, e, q, n, p, m, r, t, s, u, v, A, w = function() {
                var b = function(a) {
                        var b =
                            "";
                    ...
                    e = function(a) {
                        var b = a; - 1 !== a.search(/[-]/g) && -1 === a.search(/^\[(.*?)\]$/g) && (b = "[" + a + "]");
                        return b
                    },
                    d = function(a) {
                        for (;
                ...
                this.SponsoredLinks = function() {
                    ...
                    this.format = function() {
                        var a = "sec",
                            g = b(this.atCampaign),
                            m = f[this.atPlatform] || e(this.atPlatform),
                            l = b(this.atCreation),
                            h = b(this.atVariant),
                            s = c[this.atNetwork] || e(this.atNetwork),
                            n = b(this.atTerm);
                        return d(a + ("-" + g + "-" + m + "-" + l + "-" + h + "-" + s + "-" + n))
                    };
                    this.setProperties = function(b) {
                        var e = a.utils.getQueryStringValue(h.querystringPrefix +
                            "source", b) || "";
                        this.atCampaign = a.utils.getQueryStringValue(h.querystringPrefix + "campaign", b) || "";
                        this.atPlatform = a.utils.getQueryStringValue(h.querystringPrefix + "platform", b) || "";
                        this.atCreation = a.utils.getQueryStringValue(h.querystringPrefix + "creation", b) || "";
                        this.atVariant = a.utils.getQueryStringValue(h.querystringPrefix + "variant", b) || "";
                        this.atNetwork = a.utils.getQueryStringValue(h.querystringPrefix + "network", b) || "";
                        this.atTerm = a.utils.getQueryStringValue(h.querystringPrefix + "term", b) || "";
                ...
                this.Email = function() {
                    ...
                    this.format = function() {
                        var a = f[this.atEmailtype] || f.promotion,
                            ...
                            m = e(this.atSendDate),
                            l = b(this.atLink),
                            h = e(this.atRecipientId) + (this.atRecipientList ? "@" + e(this.atRecipientList) : ""),
                            s = e(this.atSendTime);
                        return d(a + ("-" + c + "-" + g + "-" + m + "-" + l + "-" + h + "-" + s))
                    };
                    this.setProperties = function(b) {
                        var e = a.utils.getQueryStringValue(h.querystringPrefix + "source", b) || "";
                        this.atEmailtype = a.utils.getQueryStringValue(h.querystringPrefix + "emailtype", b) || "";
                        this.atCampaign = a.utils.getQueryStringValue(h.querystringPrefix + "campaign", b) || "";
                        this.atCreation = a.utils.getQueryStringValue(h.querystringPrefix +
                            "creation", b) || "";
                        this.atSendDate = a.utils.getQueryStringValue(h.querystringPrefix + "send_date", b) || "";
                        this.atLink = a.utils.getQueryStringValue(h.querystringPrefix + "link", b) || "";
                        this.atRecipientId = a.utils.getQueryStringValue(h.querystringPrefix + "recipient_id", b) || "";
                        this.atRecipientList = a.utils.getQueryStringValue(h.querystringPrefix + "recipient_list", b) || "";
                        this.atSendTime = a.utils.getQueryStringValue(h.querystringPrefix + "send_time", b) || "";
                        a.setContext("campaigns_events", {
                            source: e,
                            medium: this.atMedium,
                ...
                this.Affiliate = function() {
                    ...
                    this.format = function() {
                        var a = "al",
                            ...
                            l =
                            b(this.atVariant);
                        return d(a + ("-" + e + "-" + f + "-" + c + "-" + g + "-" + m + "-" + l))
                    };
                    this.setProperties = function(b) {
                        var e = a.utils.getQueryStringValue(h.querystringPrefix + "source", b) || "";
                        this.atCampaign = a.utils.getQueryStringValue(h.querystringPrefix + "campaign", b) || "";
                        this.atType = a.utils.getQueryStringValue(h.querystringPrefix + "type", b) || "";
                        this.atIdentifier = a.utils.getQueryStringValue(h.querystringPrefix + "identifier", b) || "";
                        this.atFormat = a.utils.getQueryStringValue(h.querystringPrefix + "format", b) || "";
                        this.atCreation =
                            a.utils.getQueryStringValue(h.querystringPrefix + "creation", b) || "";
                        this.atVariant = a.utils.getQueryStringValue(h.querystringPrefix + "variant", b) || "";
                        a.setContext("campaigns_events", {
                            source: e,
                            medium: this.atMedium,
                ...
                this.Display = function() {
                    ...
                    this.atDetailPlacement = this.atGeneralPlacement = this.atChannel = this.atFormat = this.atVariant = this.atCreation =
                        this.atCampaign = "";
                    this.format = function() {
                        var a = "ad",
                            e = b(this.atCampaign),
                            ...
                            h = b(this.atDetailPlacement);
                        return d(a + ("-" + e + "-" + f + "-" + c + "-" + g + "-" + m + "-" + l + "-" + h))
                    };
                    this.setProperties = function(b) {
                        var e = a.utils.getQueryStringValue(h.querystringPrefix + "source", b) || "";
                        this.atCampaign = a.utils.getQueryStringValue(h.querystringPrefix + "campaign", b) || "";
                        ...
                        this.atVariant = a.utils.getQueryStringValue(h.querystringPrefix + "variant", b) || "";
                        this.atFormat = a.utils.getQueryStringValue(h.querystringPrefix + "format", b) || "";
                        this.atChannel = a.utils.getQueryStringValue(h.querystringPrefix + "channel", b) || "";
                        this.atGeneralPlacement = a.utils.getQueryStringValue(h.querystringPrefix + "general_placement", b) || "";
                        this.atDetailPlacement = a.utils.getQueryStringValue(h.querystringPrefix + "detail_placement", b) || "";
                        a.setContext("campaigns_events", {
                            source: e,
                            medium: this.atMedium,
                            campaign: this.atCampaign,
                ...
                this.Custom = function() {
                    ...
                    this.format = function() {
                        ...
                        var a = "cs" + a,
                            ...
                            g = b(this.atCustom3),
                            m = b(this.atCustom4);
                        return d(a + ("-" + e + "-" + f + "-" + c + "-" + g + "-" + m))
                    };
                    this.setProperties = function(b) {
                        var e = a.utils.getQueryStringValue(h.querystringPrefix + "source", b) || "";
                        this.atMedium = a.utils.getQueryStringValue(h.querystringPrefix + "medium", b) || "";
                        this.atCampaign = a.utils.getQueryStringValue(h.querystringPrefix + "campaign", b) || "";
                        this.atCustom1 = a.utils.getQueryStringValue(h.querystringPrefix + "custom1", b) || "";
                        this.atCustom2 = a.utils.getQueryStringValue(h.querystringPrefix + "custom2", b) || "";
                        this.atCustom3 =
                            a.utils.getQueryStringValue(h.querystringPrefix + "custom3", b) || "";
                        this.atCustom4 = a.utils.getQueryStringValue(h.querystringPrefix + "custom4", b) || "";
                        a.setContext("campaigns_events", {
                            source: e,
                            medium: this.atMedium,
                            campaign: this.atCampaign,
                ...
                this.CustomNdf = function() {
                    this.format = function() {};
                    this.setProperties = function(b) {
                        a.setProps(k(h.querystringPrefix, b, "src_"), !0)
                    }
                };
                this.medium = {
                ...
                var b = a.utils.getLocation(),
                    e = function() {
                        var e = k("utm_", b, ""),
                            d = !1,
                            f;
                        for (f in e) e.hasOwnProperty(f) && (C("utm_" + f, e[f]), d = !0);
                        d && a.setContext("campaigns_utm_events", e)
                    };
                (function() {
                    var e = a.utils.getQueryStringValue(h.querystringPrefix + "medium", b);
                    if (e && !t) {
                        var d = new w,
                            e = "function" === typeof d.medium[e] ? new d.medium[e] : 0 === e.indexOf("custom") ? new d.Custom :
                            new d.CustomNdf;
                        e.setProperties(b);
                        n = e.format()
                    } else n = a.utils.getQueryStringValue("xtor", b);
                    p = a.utils.getQueryStringValue("xtdt", b);
                    m = a.utils.getQueryStringValue("xts", b)
                })();
        ...
        (function() {
            a.plugins.waitForDependencies(["Storage", "Utils"], function() {
                c = "set" + (h.domainAttribution ? "" : "Private");
                b = "get" + (h.domainAttribution ? "" : "Private");
                d = a.storage[b](["atredir",
                    "gopc"
                ]);
                g = a.storage[b](["atredir", "gopc_err"]);
                l = a.storage[b](["atredir", "camp"]);
                a.storage.del(["atredir", "gopc"]);
                a.storage.del(["atredir", "gopc_err"]);
                a.storage.del(["atredir", "camp"]);
                f = a.storage[b](["atsession", "histo_camp"]);
                e = a.storage[b](["atreman", "camp"]);
                q = a.storage[b](["atreman", "date"]);
                r = a.getContext("forcedCampaign");
                t = a.getContext("forcedCampaignV2");
                a: {
                    var k = t;
                    if (k) {
                        var x = "",
                            y;
                        for (y in k) k.hasOwnProperty(y) && (x += "&" + h.querystringPrefix + y + "=" + k[y]);
                        if (k = a.utils.getQueryStringValue(h.querystringPrefix +
                                "medium", x)) {
                            y = new w;
                            k = "function" === typeof y.medium[k] ? new y.medium[k] : 0 === k.indexOf("custom") ? new y.Custom : new y.CustomNdf;
                            k.setProperties(x);
                            s = k.format();
                            break a
                        }
                ...
                E();
                u = !!a.getConfig("redirect");
                v = !!(n && p && m);
                A = !1;
                v && (x = (new Date).getTime() / 6E4, A = !u && m !== a.getConfig("site") || 0 > x - p || x - p >= a.getConfig("visitLifetime"));
                x = s || r || l || n;
                u && x && D("atredir", {
                    path: "/",
                    end: a.getConfig("redirectionLifetime")
                }) && (a.storage[c](["atredir", "camp"], x), k = x = !1, r || s || (l ? (x = d, k = g) : (x = v, k = A)), a.storage[c](["atredir",
                    "gopc"
                ], x), a.storage[c](["atredir", "gopc_err"], k));
                !u && e && (C("xtor", e), x = (new Date).getTime() / 36E5, x = Math.floor(x - q), C("roinbh", 0 <= x ? x : 0));
                u || (x = null, x = l ? d ? s || r || x : s || r || l : v ? s || r : s || r || n || x, f && f instanceof Array && -1 < f.indexOf(x) && (x = null), x && C("xto", x));
                if (!u && !r && !s) {
                    var z;
                    l ? g && (z = l) : A && (z = n);
                    z && C("pgt", z)
                }
                if (!u && (z = l ? s || r || l : s || r || n || null) && !(!r && !s && !l && v && A || !r && !s && l && d && g)) {
                    if ((!f || f instanceof Array && 0 > f.indexOf(z)) && D("atsession", {
                            path: "/",
                            session: 60 * a.getConfig("visitLifetime")
                        })) a.storage[c](["atsession",
                        "histo_camp"
                    ], f && f.push(z) ? f : [z]);
                    e && !h.lastPersistence || !D("atreman", {
                        path: "/",
                        session: 86400 * h.lifetime
                    }) || (a.storage[c](["atreman", "camp"], z), a.storage[c](["atreman", "date"], (new Date).getTime() / 36E5))
                }
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Storage = function(a) {
                ...
                this.setData = function(b) {
                    ...
                    if (b.name && "string" === typeof b.name) {
                        var d = b.options || {},
                            ...
                            h = d.secure || a.getConfig("cookieSecure"),
        ...
        var e = function(c, d) {
            ...
            m = function(a, b, c) {
                if (!c && d[a]) c = d[a];
                else if (c = n(a)) c.options = c.options || {}, c.options.session && "number" === typeof c.options.session && (c.options.end = c.options.session, p(c, !1)), d[a] = c;
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Utils = function(a) {
        ...
        a.utils.manageChapters = k.manageChapters = function(b, c, g) {
            var h = "";
            if (b)
                for (var f = a.getConfig("ignoreEmptyChapterValue"), e = "", k = 1; k < parseInt(g, 10) + 1; k++) e = b[c +
        ...
        a.processTagObject = function(b, c, g) {
            if ((b = a.getParam(b, !0)) && b._options.permanent) {
                for (var h = !1, f = b._options.hitType || [], e = 0; e < f.length; e++)
        ...
        a.processContextObjectAndSendHit = function(b, c, g, h) {
            var f = {
                ...
                e = a.getParam(b, !0);
            if (e) {
                for (var k = !1, n = e._options.hitType || [], p = 0; p < n.length; p++)
                ...
                k ? (k = ATInternet.Utils.cloneSimpleObject(e), k._value = ATInternet.Utils.completeFstLevelObj(k._value || {}, g, !0), a.setParam(b,
                    ...
                    a.sendHit(null, [
                        ["hitType", c.hitType]
                    ], h, c.requestMethod, c.elementType)
...
(function() {
    ...
    ATInternet.Tracker.Plugins.TechClicks = function(a) {
        var k = this,
            h = ["Tracker:Hit:Sent:Ok", "Tracker:Hit:Sent:Error", "Tracker:Hit:Sent:NoTrack"],
            c, b, d = !1;
            ...
            e = function(a) {
                ...
                c && !d && (d = !0, f(function(a) {
                    a.details.isMultiHit || a.details.elementType !== ATInternet.Utils.CLICKS_REDIRECTION ||
                        (k.timeout && clearTimeout(k.timeout), g({
                            url: c,
                            target: e
                        }))
                }), l({
    ...
    ATInternet.Tracker.Plugins.Clicks = function(a) {
        ...
        a.click.onDispatch = function(b, g) {
            var l = ["click"],
                ...
                e = a.getContext("page") || {};
            a.setParam("pclick", c(e), {
                hitType: l
            });
            a.setParam("s2click", e.level2 || "", {
                hitType: l
            });
            a.setParam("p", f.name, {
                hitType: l
        ...
        var g = function() {
            ...
            f = function() {
                if ("relative" === k.userIdExpirationMode || "fixed" === k.userIdExpirationMode && null === b.storageUserId || b.isFromTrackerContext) {
                    ...
                    a.storage.set(k.userIdStorageName, b.finalUserId, {
                        end: e,
                        path: "/"
                    }, b.forceStorage);
            ...
            e = function() {
                a.setParam(k.userIdHitName, b.finalUserId, {
                    multihit: !0,
                    permanent: !0,
                    hitType: ["all"]
                });
        ...
        var l = function(b, e) {
            ...
            v = function() {
                ...
                if (a.getConfig("redirect")) {
                    var s = a.utils.getDocumentLevel(),
                        s = c ? c : null !== k ? k : s ? s.referrer : "acc_dir",
                        v;
                    if (v = s) {
                        v = {
                            path: "/",
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Page = function(a) {
        var k = ["pageId", "chapterLabel", "update"],
            ...
            f = function(e, d, f) {
                if (d)
                    for (var g = 0; g < c.length; g++)
                        if (d.hasOwnProperty(c[g]) && d[c[g]])
                            for (var h in d[c[g]]) d[c[g]].hasOwnProperty(h) && (f ? e[b[g] + h] = d[c[g]][h] :
            ...
            p = function(b, e, d) {
                if (e)
                    for (var c in e) e.hasOwnProperty(c) && "undefined" !== typeof e[c] && (d ? b[c] = e[c] : a.setParam(c, e[c]))
            };
        a.customVars = {};
        a.customVars.set = function(b) {
            ...
            if (d) {
                if (b)
                    for (var c in b) b.hasOwnProperty(c) && (d[c] = ATInternet.Utils.completeFstLevelObj(d[c], b[c], !0))
            } else d = b;
            e.customVars = d;
            a.setContext("page", e)
        };
...
(function() {
    ...
    ATInternet.Tracker.Plugins.EventRoot = function(a) {
        var k = {},
            h = function(a) {
                for (var b = [], e, d = 0; d < a.length; d++)
                    for (var c in a[d]) a[d].hasOwnProperty(c) && (e = ATInternet.Utils.isObject(a[d][c]) ? ATInternet.Utils.objectToLowercase(a[d][c]) : a[d][c], b.push({
                        name: c.toLowerCase(),
                        data: e
                    }));
            ...
            b = function(b, d, e) {
                ...
                if ("undefined" !== typeof b) {
                    ...
                    b.name &&
                        (g.$ = b.name);
                    for (var h = a.getConfig("ignoreEmptyChapterValue"), m = "", k = "", t = 1; 3 >= t; t++)
                        if (k = "chapter" + t, m = b[k] || "", h && m || !h && b.hasOwnProperty(k)) g[k] = m;
                    b.url && (g.url = b.url);
                    h = {};
                    "string" === typeof b.level2 ? (b = ATInternet.Utils.trim(b.level2), 0 < b.length && (isNaN(b) ? h.level2 = b : h.level2_id = Number(b))) : "number" === typeof b.level2 && (h.level2_id = b.level2)
                }
                b = {};
                ATInternet.Utils.isEmptyObject(g) || (b.page = g);
                ATInternet.Utils.isEmptyObject(h) || (b.site = h);
                "undefined" !== typeof d && (b.src = d);
                "undefined" !== typeof e &&
                    (b.utm = e);
                ATInternet.Utils.isEmptyObject(b) || (c = ATInternet.Utils.jsonSerialize([{
                    data: b
                }]));
                return c
            },
        ...
        a.event.send = function(d,
            c, e) {
            var g = !0,
                n = "",
                p = "event";
            e && e.origin && (p = e.origin);
            var m = {};
            m[d] = c;
            var r = {};
            r[k.hitParameter] = {
            ...
            d = a.getContext("page");
            c = a.getContext("campaigns_events");
            var t = a.getContext("campaigns_utm_events");
            if ("undefined" !== typeof d || "undefined" !== typeof c || "undefined" !== typeof t) r.context = {
                _value: b(d, c, t),
                _options: {
                    truncate: !0,
                    encode: !0
            ...
            ATInternet.Utils.isPreview() && a.getConfig("preview") &&
                (r.pvw = 1);
            e && !ATInternet.Utils.isTabOpeningAction(e.event) && e.elem && (m = a.techClicks.manageClick(e.elem), g = m.preservePropagation, n = m.elementType);
            a.manageSend(function() {
                var b;
                e && (b = e.callback);
                a.sendHit(r, [
        ...
        a.event.set = function(b, d, e, c) {
            c = c || "event";
            a.setParam(k.hitParameter, k.hitValue, {
                multihit: !0,
                hitType: [c]
            });
            a.dispatchSubscribe(c);
            for (var h = a.getContext(c) || [], p = !1, m = 0; m < h.length; m++) h[m][b] && (p = !0, e ? ATInternet.Utils.isObject(h[m][b]) && (h[m][b][e] = g(h[m][b][e],
                d)) : h[m][b] = g(h[m][b], d));
            p || (p = {}, e ? (p[b] = {}, p[b][e] = d) : p[b] = d, h.push(p));
            a.setContext(c, h)
        };
        a.event.add = function(b, d, e) {
            e = e || "event";
            var c = a.getContext(e) || [],
                g = {};
            g[b] = d;
            c.push(g);
            a.setContext(e, c)
        };
        a.event.onDispatch = function(b, f, e) {
            var g = e || "event";
            e = a.getContext("page");
            var h = a.getContext("campaigns_events"),
                k = a.getContext("campaigns_utm_events");
            "undefined" === typeof e && "undefined" === typeof h && "undefined" === typeof k || d(e, h, k, g);
            e = a.getContext(g);
            "undefined" !== typeof e && c(e, g);
            a.delContext(g);
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Ecommerce = function(a) {
        ...
        a.ecommerce.cartAwaitingPayment.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    b = k.objectKeysFromLegacyToNewFormat(b);
                    var d = {};
                    d.cart = b;
                    b = ATInternet.Utils.uuid();
                    d.cart.version = b.v4().split("-")[0];
                    h.updateProductAwaitingPayment(d.cart);
                    a.event.set("cart.awaiting_payment", d.cart, "cart", "ecommerce")
                }
            }
        };
        a.ecommerce.cartAwaitingPayment.products = {
            set: function(a) {
                if (a instanceof Array) {
                    a = k.arrayObjectKeysFromLegacyToNewFormat(a);
                    var d = h.getObjectValueFromType("cart.awaiting_payment", "cart"),
                        c = {};
                    d.id && (c.id = d.id);
                    d.version && (c.version = d.version);
                    h.setProductAwaitingPayment(a, c)
                }
            }
        };
        a.ecommerce.cartAwaitingPayment.shipping = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    b =
                        k.objectKeysFromLegacyToNewFormat(b);
                    var d = {};
                    d.shipping = b;
                    a.event.set("cart.awaiting_payment", d.shipping, "shipping", "ecommerce")
                }
            }
        };
        a.ecommerce.cartAwaitingPayment.payment = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.payment = b;
                    a.event.set("cart.awaiting_payment", d.payment, "payment", "ecommerce")
                }
            }
        };
        a.ecommerce.cartAwaitingPayment.transaction = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    d.transaction =
                        b;
                    a.event.set("cart.awaiting_payment", d.transaction, "transaction", "ecommerce")
                }
            }
        };
        a.ecommerce.displayProduct.products = {
            set: function(a) {
                a instanceof Array && (a = k.arrayObjectKeysFromLegacyToNewFormat(a), h.setProductDisplay(a))
            }
        };
        a.ecommerce.displayPageProduct.products = {
            set: function(a) {
                a instanceof Array && (a = k.arrayObjectKeysFromLegacyToNewFormat(a), h.setProductPageDisplay(a))
            }
        };
        a.ecommerce.addProduct.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("product.add_to_cart", d.cart, "cart", "ecommerce");
                    h.updateCartCreation(d.cart)
                }
            }
        };
        a.ecommerce.addProduct.products = {
            set: function(a) {
                if (a instanceof Array) {
                    a = k.arrayObjectKeysFromLegacyToNewFormat(a);
                    for (var d = !1, c = h.getObjectValueFromType("product.add_to_cart", "cart").id, c = h.initCartWithId(c), l = 0; l < a.length; l++) c.currency = a[l].currency, c.turnovertaxincluded += (Number(a[l].pricetaxincluded) || 0) * (Number(a[l].quantity) || 0), c.turnovertaxfree += (Number(a[l].pricetaxfree) || 0) * (Number(a[l].quantity) ||
                        0), c.quantity += Number(a[l].quantity) || 0, c.nbdistinctproduct += 1, Boolean(Number(a[l].cartcreation)) && (d = !0);
                    l = {};
                    c.id && (l.id = c.id);
                    h.setProductAddToCart(a, l);
                    d && h.setCartCreation(c)
                }
            }
        };
        a.ecommerce.removeProduct.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("product.remove_from_cart", d.cart, "cart", "ecommerce")
                }
            }
        };
        a.ecommerce.removeProduct.products = {
            set: function(a) {
                if (a instanceof Array) {
                    a = k.arrayObjectKeysFromLegacyToNewFormat(a);
                    var d = {};
                    d.id = h.getObjectValueFromType("product.remove_from_cart", "cart").id;
                    var c = {};
                    d.id && (c.id = d.id);
                    h.setProductRemoveFromCart(a, c)
                }
            }
        };
        a.ecommerce.displayCart.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("cart.display", d.cart, "cart", "ecommerce")
                }
            }
        };
        ...
        a.ecommerce.updateCart.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("cart.update", d.cart, "cart", "ecommerce")
                }
            }
        };
        a.ecommerce.deliveryCheckout.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("cart.delivery", d.cart, "cart", "ecommerce")
                }
            }
        };
        a.ecommerce.deliveryCheckout.shipping = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.shipping = b;
                    a.event.set("cart.delivery", d.shipping, "shipping", "ecommerce")
                }
            }
        };
        a.ecommerce.paymentCheckout.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("cart.payment", d.cart, "cart", "ecommerce")
                }
            }
        };
        a.ecommerce.paymentCheckout.shipping = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.shipping = b;
                    a.event.set("cart.payment", d.shipping, "shipping", "ecommerce")
                }
            }
        };
        a.ecommerce.transactionConfirmation.cart = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.cart = b;
                    a.event.set("transaction.confirmation", d.cart, "cart", "ecommerce");
                    h.updateProductPurchased(null, d.cart)
                }
            }
        };
        a.ecommerce.transactionConfirmation.discount = {
            set: function(b) {
                if (b instanceof Array) {
                    ...
                    d.transaction.promocode = b;
                    a.event.set("transaction.confirmation", d.transaction, "transaction", "ecommerce")
                }
            }
        };
            ...
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    d.transaction =
                        b;
                    a.event.set("transaction.confirmation", d.transaction, "transaction", "ecommerce");
                    h.updateProductPurchased(d.transaction, null)
                }
            }
        };
        a.ecommerce.transactionConfirmation.shipping = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.shipping = b;
                    a.event.set("transaction.confirmation", d.shipping, "shipping", "ecommerce")
                }
            }
        };
        a.ecommerce.transactionConfirmation.payment = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    var d = {};
                    d.payment = b;
                    a.event.set("transaction.confirmation", d.payment, "payment", "ecommerce")
                }
            }
        };
        a.ecommerce.transactionConfirmation.customer = {
            set: function(b) {
                if (ATInternet.Utils.isObject(b)) {
                    ...
                    d.transaction.firstpurchase = b[c["new"]];
                    a.event.set("transaction.confirmation", d.transaction, "transaction", "ecommerce")
                }
            }
        };
        a.ecommerce.transactionConfirmation.products = {
            set: function(a) {
                if (a instanceof Array) {
                    a = k.arrayObjectKeysFromLegacyToNewFormat(a);
                    for (var d = [], c = h.getObjectValueFromType("transaction.confirmation", "cart"), l = h.getObjectValueFromType("transaction.confirmation", "transaction"), f = 0; f < a.length; f++) d.push(a[f]);
                    h.setProductPurchased(d, l, c)
                }
            }
        };
        k = new function() {
            this.objectKeysFromLegacyToNewFormat = function(a) {
                var d = {},
                    c, l;
                for (l in a) a.hasOwnProperty(l) && (c = l.toLowerCase(), c = "name" === c ? "$" : c, d[c] = a[l]);
                return d
            };
            this.arrayObjectKeysFromLegacyToNewFormat = function(a) {
                for (var d = [], c = 0; c < a.length; c++) d.push(k.objectKeysFromLegacyToNewFormat(a[c]));
                return d
            }
        };
        h = new function() {
            this.initCartWithId = function(a) {
                ...
                d.id = a;
                d.currency = "";
                d.turnovertaxincluded = 0;
                d.turnovertaxfree = 0;
                d.quantity = 0;
                d.nbdistinctproduct = 0;
                return d
            };
            this.getObjectValueFromType = function(b, d) {
                for (var c, l = {}, f = a.getContext("ecommerce") || [], e = 0; e < f.length; e++)
                    if (c = f[e][b] || {}, c[d]) {
                        l = c[d];
                        break
                    }
            ...
            this.setEventFromProductsAndCart = function(b, d, c) {
                d = d || [];
                for (var l = {}, f = 0; f < d.length; f++) 0 === f ? (a.event.set(b, d[f], "product", "ecommerce"), c && 0 !== Object.keys(c).length &&
                    a.event.set(b, c, "cart", "ecommerce")) : (l.product = d[f], c && 0 !== Object.keys(c).length && (l.cart = c), a.event.add(b, l, "ecommerce")), l = {}
            };
            this.setProductAwaitingPayment = function(a, d) {
                this.setEventFromProductsAndCart("product.awaiting_payment", a, d)
            };
            this.updateProductAwaitingPayment = function(b) {
                var d = b ? b.id : "";
                b = b ? b.version : "";
                if (d && b)
                    for (var c, l = a.getContext("ecommerce") || [], f = 0; f < l.length; f++)
                        if (c = l[f]["product.awaiting_payment"]) c.cart = {}, c.cart.id = d, c.cart.version = b, l[f]["product.awaiting_payment"] = c
            };
            ...
            this.setProductAddToCart = function(a, d) {
                this.setEventFromProductsAndCart("product.add_to_cart", a, d)
            };
            this.setProductRemoveFromCart = function(a, d) {
                this.setEventFromProductsAndCart("product.remove_from_cart", a, d)
            };
            this.setCartCreation = function(b) {
                var d = {};
                d.cart = b;
                a.event.set("cart.creation", d, null, "ecommerce")
            };
            this.updateCartCreation = function(b) {
                if (b = b ? b.id : "")
                    for (var d, c = a.getContext("ecommerce") || [], l = 0; l < c.length; l++)(d = c[l]["cart.creation"]) && d.cart && (d.cart.id = b, c[l]["cart.creation"] = d)
            };
            this.setProductPurchased = function(b, d, c) {
                b = b || [];
                d = d ? d.id : "";
                c = c ? c.id : "";
                for (var l = {}, f = 0; f < b.length; f++) l.transaction = {}, l.transaction.id = d, l.cart = {}, l.cart.id = c, l.product = b[f], 0 === f ? a.event.set("product.purchased", l, null, "ecommerce") : a.event.add("product.purchased", l, "ecommerce"), l = {}
            };
            this.updateProductPurchased =
                function(b, d) {
                    for (var c = b ? b.id : "", l = d ? d.id : "", f, e = a.getContext("ecommerce") || [], h = 0; h < e.length; h++)
                        if (f = e[h]["product.purchased"]) c && f.transaction ? f.transaction.id = c : l && f.cart && (f.cart.id = l), e[h]["product.purchased"] = f
                }
        };
        a.ecommerce.onDispatch = function(b, d) {
            a.event.onDispatch(b, d, "ecommerce")
        }
    };
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Events = function(a) {
        var k = function(a) {
            ...
            ATInternet.Utils.object2Flatten(a, null, c, null, !0);
            a = {};
            for (var b in c) c.hasOwnProperty(b) && ATInternet.Utils.flatten2Object(a, b, c[b]);
            return ATInternet.Utils.getFormattedObject(a)
        };
        a.events = {};
        a.events.send = function(h, c, b) {
            b = b || {};
            b.origin = "events";
            var d = c;
            ATInternet.Utils.isObject(c) && (d = k(c));
            a.event.send(h, d, b)
        };
        a.events.add = function(h, c) {
            var b = c;
            ATInternet.Utils.isObject(c) && (b = k(c));
            for (var d = a.getContext("events") || [], g = !1, l = 0; l < d.length; l++)
                if (typeof d[l].hasOwnProperty(h)) {
                    g = !0;
                    break
                }
            g ? a.event.add(h, b, "events") : a.event.set(h, b, null, "events")
        };
        a.events.onDispatch = function(h, c) {
            a.event.onDispatch(h, c, "events")
        }
    };
    ...
    ATInternet.Tracker.Plugins.IdentifiedVisitor = function(a) {
        ...
        var m = function(b, e) {
            ...
            u = function() {
                ...
                a(e, d || l);
                e.id ? (e.category && s("ac", e.category, !0), s("at", e.id, !0)) : k && (s("at", k, !1), c && s("ac", c, !1));
                b.id ? (b.category && s("ac", b.category, !0), s("an", b.id, !0)) : h && s("anc", c + "-" + h, !1)
            };
        a.plugins.waitForDependencies(["Storage",
            "Utils"
        ], function() {
            e = p.domainAttribution ? "set" : "setPrivate";
            q = p.domainAttribution ? "get" : "getPrivate";
            n = p.domainAttribution ? "del" : "delPrivate";
            var s = a.utils.getLocation();
            d = a.utils.getQueryStringValue("xtat", s);
            g = a.utils.getQueryStringValue("xtan", s);
            a.getConfig("redirect") ? (d || g) && r("atredir", {
                path: "/",
                end: a.getConfig("redirectionLifetime")
            }) && (g && m(e, [
                ["atredir", "an"], g
                ...
                k = m(q, [
                    ...
                    ["atidvisitor", "vrn"]
                ]), u(), s = "-" + a.getConfig("site") + "-", RegExp(s).test(b) || (b = (b || "") + s, t("vrn", b), s = a.getContext("page") || {}, s.vrn = 1, a.setContext("page", s)));
            a.emit("IdentifiedVisitor:Ready", {
                lvl: "INFO",
                details: {
                    storageRedirectTextual: l,
        ...
        a.identifiedVisitor.set = function(a) {
            ...
            var b =
                a.id;
            a = a.category;
            "number" === typeof b ? s("an", b.toString(), !0) : "string" === typeof b && s("at", b, !0);
            "undefined" !== typeof a && s("ac", a, !0)
        };
        a.identifiedVisitor.unset = function() {
            for (var b = ["an", "at", "ac"], e = 0; e < b.length; e++) m(n, [
                ["atidvisitor", b[e]]
            ]), a.delParam(b[e]);
            a.delParam("anc")
        }
...
(function() {
    ...
    ATInternet.Tracker.Plugins.InternalSearch = function(a) {
        ...
        a.internalSearch.send = function(h) {
            ...
            var d = {
                np: "undefined" !== typeof h.resultPageNumber ? h.resultPageNumber : "1",
                click: "IS"
            };
        ...
        a.plugins.waitForDependencies(["Utils"], function() {
            ...
            a.emit("InternalSearch:Ready", {
                ...
                details: {
                    config: {
                        urlKeyword: k.urlKeyword,
                        urlResultPageNumber: k.urlResultPageNumber
                    },
                    url: c,
                    data: h
                }
...
(function() {
    ...
    window.ATInternet.Tracker.Plugins.MvTesting = function(a) {
        var k = 0,
            h = function(a, b) {
                var c = "";
                a.hasOwnProperty(b) && (c = a[b], c = void 0 === c ? "" : c + "");
                return c
            },
            c = function(a) {
        ...
        a.mvTesting.set = function(b) {
            if (c(b) && !ATInternet.Utils.isEmptyObject(b)) {
                a.dispatchSubscribe("mvTesting");
                var g = h(b, "test"),
                    k = h(b, "waveId");
                b = h(b, "creation");
                a.setParam("abmvc", g + "-" + k + "-" + b, {
                    hitType: ["mvtesting"]
                })
            }
        };
        a.mvTesting.add = function(b) {
            if (c(b) && !ATInternet.Utils.isEmptyObject(b)) {
                ...
                b = h(b, "version");
                k++;
                a.setParam("abmv" + k, g + "-" + b, {
                    hitType: ["mvtesting"]
                })
            }
        };
        a.mvTesting.onDispatch = function(d) {
            var c = a.getContext("page") || {};
            a.setParam("p", b(c), {
                hitType: ["mvtesting"]
            });
            "undefined" !== typeof c.level2 && a.setParam("s2", c.level2, {
                hitType: ["mvtesting"]
            });
            a.setParam("type", "mvt", {
                hitType: ["mvtesting"]
    ...
    ATInternet.Tracker.Plugins.Offline = function(a) {
        function k(b, e, p, m) {
            if (window.navigator && window.navigator.onLine) {
                ...
                if (0 < r.length) {
                    ...
                    c || (a.onTrigger("Tracker:Hit:Sent:Ok", function(a, d) {
                        b && d.details.hit === b || k(b, e, p, m)
                    }, !1), a.onTrigger("Tracker:Hit:Sent:Error", function(a, d) {
                        b && d.details.hit === b || k(b, e, p, m)
                    }, !1), c = !0);
                    a.sendUrl(t, null, "GET", m)
                } else b && (a.utils.getQueryStringValue("a", b) ? setTimeout(function() {
                    a.sendUrl(b, null, null, null)
                }, h.timeout) : a.sendUrl(b, e, p, m))
            } else b &&
                (f(l(b)), e && e())
        }
        var h = {},
        ...
        var b = function() {
            ...
            f = function(a) {
                var e = b(),
                    c = a.length,
                    f = !0;
                if (4 * ((e.length || 11) + c) > 1048576 * h.storageCapacity) {
                    var f = !1,
                        g = e.hits.shift();
                    if ("undefined" !== typeof g)
                        for (var f = !0, k = g.length; k < c;)
                            if (g = e.hits.shift(), "undefined" !== typeof g) k += g.length;
                            else {
                                f = !1;
                                break
                            }
            ...
            e = function(b) {
                a.builder.sendUrl = function(a, e, d, c) {
                    b || window.navigator && !window.navigator.onLine ? (f(l(a)), e && e()) : k(a, e, d, c)
                }
            };
        a.offline = {};
        ...
        a.plugins.waitForDependencies(["Utils"], function() {
            var b = ATInternet.Utils.isLocalStorageAvailable(),
                d;
            window.navigator && (d = window.navigator.onLine);
            b && "undefined" !== typeof d && ("required" === h.storageMode ? e(!1) : "always" === h.storageMode && e(!0));
    ...
    ATInternet.Tracker.Plugins.OnSiteAds = function(a) {
                ...
                if (c) {
                    ...
                    if (c.campaignId) {
                        var f = f || "PUB",
                            ...
                            k = b(c, "variant"),
                            s = b(c, "format"),
                            l = b(c, "generalPlacement"),
                            v = b(c, "detailedPlacement"),
                            A = b(c, "advertiserId"),
                            c = b(c, "url");
        ...
        a.onSiteAds.onDispatch = function(b, d) {
            if (!a.dispatchSubscribed("page")) {
                ...
                var f = a.getContext("page") || {};
                a.getParam("atc") && (a.setParam("patc", c(f), {
                    hitType: ["publisher", "selfPromotion"]
    ...
    ATInternet.Tracker.Plugins.Privacy = function(a) {
        var k = function(c) {
                function b() {
                    if (p && m) {
                        var b = new Date;
                        b.setTime(b.getTime() + 864E5 * m.storageDuration);
                ...
                function d(e) {
                    m && (0 < m.storageDuration ? e ? b() : (e = a.storage.get(t.authorityStorageName, !0), null === e ? b() : "object" === typeof e && (e.authority_name === p.name && e.visitor_mode === m.name || b())) : a.storage.del(t.authorityStorageName))
                }
                ...
                function f(a, b, e) {
                    if (m && m.include) {
                        m.include[b] instanceof Array ? a instanceof Array ? m.include[b] = m.include[b].concat(a) : a && m.include[b].push(a) : m.include[b] !== ATInternet.Utils.privacy.ALL && (a instanceof Array ? m.include[b] = a : a && (m.include[b] = [a]));
                        a = r;
                        var d = b + "Params",
                            c = m.include[b];
                        b = [];
                        for (var f = {}, g = 0; g < c.length; g++)
                            if ("object" === typeof c[g])
                                for (var h in c[g]) c[g].hasOwnProperty(h) && (f[h] = (f[h] || []).concat(c[g][h]));
                            else b.push(c[g]);
                        for (var k in f) f.hasOwnProperty(k) && (h = {}, h[k] = f[k], b.push(h));
                        a[d] = b;
                        ATInternet.Utils.privacy.setParameters(r);
                        e && e()
                    }
                }
                ...
                function e(b, e, c, f) {
                    if (t.authorities && t.authorities[b] && t.authorities[b][e]) {
                        ...
                        p = t.authorities[b];
                        m = p[e];
                        ATInternet.Utils.privacy.setMode(e);
                        if (m)
                            for (var w in m.trackerSettings) m.trackerSettings.hasOwnProperty(w) && a.setConfig(w, m.trackerSettings[w]);
                        if (m && m.add)
                            for (var C in m.add.buffer) m.add.buffer.hasOwnProperty(C) && a.setParam(m.add.buffer[C].param, m.add.buffer[C].value, {
                                multihit: !0,
                                permanent: !0,
                                hitType: ["all"]
                            });
                        if (m && m.include) {
                            for (var E in m.include) m.include.hasOwnProperty(E) && (b = m.include[E] instanceof Array ? m.include[E] : [m.include[E]], r[E + "Params"] = b);
                            ATInternet.Utils.privacy.setParameters(r);
                            d(!1)
                        }
                ...
                function k() {
                    for (var b = r.bufferParams, e = b.length, d = 0; d < e; d++) {
                        var c = b[d];
                        if (c === ATInternet.Utils.privacy.ALL) {
                            a.contextVariables.setAll();
                            break
                        }(c = a.contextVariables.params[c]) && c()
                    }
                }
                var n = this,
                    p = null,
                ...
                n.updateStorageDuration = function(a) {
                    m && (m.storageDuration = a, d(!0))
                };
                (function() {
                    var b = a.storage.get([t.authorityStorageName, "authority_name"], !0),
                        e = a.storage.get([t.authorityStorageName, "visitor_mode"], !0);
                    b && e && ("default" === b ? "optin" === e ? n.setVisitorOptin() : "optout" === e ? n.setVisitorOptout() :
        ...
        (function() {
            a.plugins.waitForDependencies(["Storage", "Utils", "ClientSideUserId", "ContextVariables"],
                function() {
                    ...
                    null !== c && (h = new k(c), a.privacy.setVisitorOptout = h.setVisitorOptout, a.privacy.setVisitorOptin = h.setVisitorOptin, a.privacy.setVisitorRandomID = h.setVisitorRandomID, a.privacy.setVisitorMode = h.setVisitorMode, a.privacy.getAuthority = h.getAuthority, a.privacy.getVisitorMode = h.getVisitorMode, a.privacy.addAuthority = h.addAuthority, a.privacy.extendIncludeStorage = h.extendIncludeStorage, a.privacy.extendIncludeBuffer =
...
(function() {
    ...
    ATInternet.Tracker.Plugins.SalesTracker = function(a) {
        var k = 0,
            h = function(b, c, g) {
                b.hasOwnProperty(g) && (b = b[g], a.setParam(c, void 0 === b || null === b ? "" : b + "", {
                    hitType: ["page"]
                }))
            },
            c = function(b) {
        ...
        a.order.set = function(b) {
            ...
            if (ATInternet.Utils.isObject(b) && !ATInternet.Utils.isEmptyObject(b)) {
                ...
                var g = b.amount;
                ATInternet.Utils.isObject(g) && (h(g, "mtht", "amountTaxFree"), h(g, "mtttc", "amountTaxIncluded"), h(g, "tax", "taxAmount"));
                g = b.delivery;
                ATInternet.Utils.isObject(g) && (h(g, "fp", "shippingFeesTaxIncluded"), h(g, "fpht", "shippingFeesTaxFree"), h(g, "dl", "deliveryMethod"));
                h(b, "mp", "paymentMethod");
                g = b.discount;
                ATInternet.Utils.isObject(g) && (h(g, "dsc", "discountTaxIncluded"), h(g, "dscht", "discountTaxFree"), h(g, "pcd", "promotionalCode"));
                ...
                if (b instanceof Array)
                    for (g = 0; g < b.length; g++) h(b, "o" + (g + 1), g)
            }
            return c
        };
        a.cart.set = function(b) {
            var c = !1;
            ATInternet.Utils.isObject(b) && !ATInternet.Utils.isEmptyObject(b) && (c = !0, a.dispatchSubscribe("page"), a.dispatchSubscribe("salesTracker"), h(b, "idcart", "cartId"), "boolean" === typeof b.isBasketPage ? "pre1" !== a.getParams("tp") && a.setParam("tp", b.isBasketPage ? "cart" : "", {
                hitType: ["page"]
        ...
        a.cart.add = function(b) {
            ...
            if (ATInternet.Utils.isObject(b) && !ATInternet.Utils.isEmptyObject(b) && (c = !0, b = b.product,
                ...
                k++;
                var g = k,
                    l = b.productId ? b.productId : "",
                    f = b.category ? b.category + "::" : "",
                    e = a.utils.manageChapters(b, "category", 6);
                e && (f = e);
                a.setParam("pdt" + g, f + l, {
                    hitType: ["page"]
                });
                h(b, "qte" + g, "quantity");
                h(b, "mt" + g, "unitPriceTaxIncluded");
                h(b, "mtht" + g, "unitPriceTaxFree");
                h(b, "dsc" + g, "discountTaxIncluded");
                h(b, "dscht" + g, "discountTaxFree");
                h(b, "pcode" + g, "promotionalCode")
            }
            return c
        };
        ...
        a.product.add = function(b) {
            var c = !1,
                g;
            if (g = ATInternet.Utils.isObject(b))
                if (g = !ATInternet.Utils.isEmptyObject(b)) {
                    a: {
                        g = ["productId"];
            ...
            g && (c = !0, g = "", (h = a.utils.manageChapters(b, "category", 6)) && (g = h), g += b.productId, b = a.getContext("product") || {}, b.viewedProducts ? b.viewedProducts.push(g) : b.viewedProducts = [g], a.setContext("product", b), a.dispatchSubscribe("salesTracker"));
            return c
        };
        a.salesTracker.onDispatch = function(b) {
            var d = a.getContext("product");
            if (d && d.viewedProducts) {
                var g = ["product"],
                    h = a.getContext("page");
                "undefined" !== typeof h && (a.setParam("p", c(h), {
                    hitType: g
                }), "undefined" !== typeof h.level2 && a.setParam("s2", h.level2, {
                    hitType: g
                }));
                a.setParam("pdtl", d.viewedProducts.join("|"), {
                    truncate: !0,
                    hitType: g
                });
                a.setParam("type", "pdt", {
...
(function() {
    ...
    ATInternet.Tracker.Plugins.Weborama = function(a) {
        var k = {},
            ...
            f = function() {
                ...
                k.callback = "(function(weboObject){window.ATInternet.Weborama.callback(weboObject," + b + ")})";
                k.url = ("https:" === document.location.protocol ? "https://" :
                    "http://") + k.baseUrl
            },
            e = function(b, c) {
                var d = null;
            ...
            n = function() {
                ...
                q("atwebosession", f) && null === d && e(c, ["atwebosession", h, f]);
                a.onTrigger("Tracker:Hit:Sent:Ok", function() {
                    e(b, ["atwebosession"])
                });
                null === e(b, ["atwebosession", !0]) && h.info.errors.push("storageError")
            },
            p = function() {
                var b =
                    a.getContext("page") || {},
            ...
            m = function() {
                ...
                ATInternet.Utils.loadScript({
                    url: k.url + "&a.si=" + k.accountId + "&a.cb=" + k.callback + "&rn=" + Math.random()
                }, function(a) {
                    g || (null !== a && h.info.errors.push("noScript"), n(), p())
                });
                setTimeout(function() {
                    l || (h.info.errors.push("timeout"), g = !0, n(), p())
                }, 500)
            };
        a.weborama = {};
        a.weborama.set = function() {
            ...
            if (a.getConfig("disableCookie") || a.getConfig("disableStorage")) h.info.message = "disableStorage:true", p();
            else if (c = "set" + (k.domainAttribution ? "" : "Private"), b = "get" + (k.domainAttribution ? "" : "Private"), d = e(b, ["atwebosession"])) {
                var g = ATInternet.Utils.arrayIndexOf(d.info.errors, "timeout");
                0 < d.info.message.length && -1 !== g ? (d.info.errors.splice(g, 1), h.info = d.info, d = null) : h.info.message = "sessionAlreadyActive";
                n();
                p()
            } else k.baseUrl &&
                "string" === typeof k.baseUrl ? m() : (h.info.message = "noURLSet", n(), p())
        };
        a.weborama.callback = function(a) {
            "undefined" !== typeof a ? (h.info.message = a.last_action ? a.last_action : "noAction", a.webo_cid && (h.info.userid = a.webo_cid)) : h.info.errors.push("noData");
            g && (d = null, n())
        };
    ...
    window.ATInternet.Weborama = {
        ...
        callback: function(a, k) {
            for (var h = window.ATInternet.Weborama.tagInstances, c = 0; c < h.length; c++) h[c].getConfig("Weborama").id === k && h[c].weborama.callback(a)
        }
    };
